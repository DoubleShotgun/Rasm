...
/* Compile hash: 4WaSfWuQuDhdaNdeLpn8LPFYmdto */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef nelua_sequence_uint8_ (*function_5eEbjf538Z6KdX8HB)(nluint64_arr3);
struct nelua_V_5 {
  uint16_t argc;
  function_5eEbjf538Z6KdX8HB assemble;
};
...
typedef elf_elf64Rel* elf_elf64Rel_ptr;
struct elf_elf64Rel {
  uint64_t r_offset;
  uint64_t r_info;
};
...
static NELUA_INLINE elf_elf64Rel_ptr nelua_span_elf64Rel____atindex(nelua_span_elf64Rel_ self, uintptr_t i);
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_zX6A25XsXYzcUXzZ)(nelua_sequence_string__1, int64_t);
...
typedef struct nlmulret_function_zX6A25XsXYzcUXzZ_nelua_sequence_string__1_nlint64 {
  function_zX6A25XsXYzcUXzZ r1;
  nelua_sequence_string__1 r2;
  int64_t r3;
} nlmulret_function_zX6A25XsXYzcUXzZ_nelua_sequence_string__1_nlint64;
static NELUA_INLINE nlmulret_function_zX6A25XsXYzcUXzZ_nelua_sequence_string__1_nlint64 nelua_ipairs_1(nelua_sequence_string__1 a);
...
typedef nlmulret_nlboolean_nlint64_nluint8 (*function_3JUpn8ZeDuk6j1wG9)(nlstring_ptr, int64_t);
typedef struct nlmulret_function_3JUpn8ZeDuk6j1wG9_nlstring_ptr_nlint64 {
  function_3JUpn8ZeDuk6j1wG9 r1;
  nlstring_ptr r2;
  int64_t r3;
} nlmulret_function_3JUpn8ZeDuk6j1wG9_nlstring_ptr_nlint64;
static NELUA_INLINE nlmulret_function_3JUpn8ZeDuk6j1wG9_nlstring_ptr_nlint64 nelua_ipairs_2(nlstring_ptr a);
static NELUA_INLINE nlmulret_nlboolean_nlint64_nluint8 nelua_ipairs_next_1(nlstring_ptr a_2, int64_t k);
typedef nlmulret_nlboolean_nlint64_nluint8 (*function_y25EPiLYbbKkURyU)(nelua_sequence_uint8_, int64_t);
typedef struct nlmulret_function_y25EPiLYbbKkURyU_nelua_sequence_uint8__nlint64 {
  function_y25EPiLYbbKkURyU r1;
  nelua_sequence_uint8_ r2;
  int64_t r3;
} nlmulret_function_y25EPiLYbbKkURyU_nelua_sequence_uint8__nlint64;
static NELUA_INLINE nlmulret_function_y25EPiLYbbKkURyU_nelua_sequence_uint8__nlint64 nelua_ipairs_3(nelua_sequence_uint8_ a);
static NELUA_INLINE nlmulret_nlboolean_nlint64_nluint8 nelua_ipairs_next_2(nelua_sequence_uint8_ a_3, int64_t k);
...
typedef nlmulret_nlboolean_nlpointer_nlusize (*function_3WD9agLsVsiKdpZMn)(nelua_hashmap_iteratorT_1_ptr, void*);
...
typedef struct nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer {
  function_3WD9agLsVsiKdpZMn r1;
  nelua_hashmap_iteratorT_1 r2;
  void* r3;
} nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer;
static NELUA_INLINE nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer nelua_pairs_1(nelua_hashmap_pointer__usize__ptr a);
...
typedef nlmulret_nlboolean_nlstring_nluint32 (*function_yo2zyTZVDd3HZ8nr)(nelua_hashmap_iteratorT_6_ptr, nlstring);
...
typedef struct nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring {
  function_yo2zyTZVDd3HZ8nr r1;
  nelua_hashmap_iteratorT_6 r2;
  nlstring r3;
} nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring;
static NELUA_INLINE nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring nelua_pairs_2(nelua_hashmap_string__uint32__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_4vSM2TPoV7UbANK5U)(nelua_hashmap_iteratorT_ptr, void*);
...
typedef struct nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer {
  function_4vSM2TPoV7UbANK5U r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer;
static NELUA_INLINE nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
typedef struct NELUA_MAYALIAS nluint8_arr1 {uint8_t v[1];} nluint8_arr1;
typedef union NELUA_MAYALIAS nluint8_arr1_cast {nluint8_arr1 a; uint8_t p[1];} nluint8_arr1_cast;
NELUA_STATIC_ASSERT(sizeof(nluint8_arr1) == 1 && NELUA_ALIGNOF(nluint8_arr1) == 1, "Nelua and C disagree on type size or align");
static NELUA_INLINE nelua_sequence_uint8_ nelua_sequence_uint8____convert_2(nluint8_arr1 values);
typedef struct NELUA_MAYALIAS nluint8_arr2 {uint8_t v[2];} nluint8_arr2;
typedef union NELUA_MAYALIAS nluint8_arr2_cast {nluint8_arr2 a; uint8_t p[2];} nluint8_arr2_cast;
NELUA_STATIC_ASSERT(sizeof(nluint8_arr2) == 2 && NELUA_ALIGNOF(nluint8_arr2) == 1, "Nelua and C disagree on type size or align");
static NELUA_INLINE nelua_sequence_uint8_ nelua_sequence_uint8____convert_3(nluint8_arr2 values);
typedef struct NELUA_MAYALIAS nluint8_arr8 {uint8_t v[8];} nluint8_arr8;
typedef union NELUA_MAYALIAS nluint8_arr8_cast {nluint8_arr8 a; uint8_t p[8];} nluint8_arr8_cast;
NELUA_STATIC_ASSERT(sizeof(nluint8_arr8) == 8 && NELUA_ALIGNOF(nluint8_arr8) == 1, "Nelua and C disagree on type size or align");
static NELUA_INLINE nelua_sequence_uint8_ nelua_sequence_uint8____convert_4(nluint8_arr8 values);
...
static NELUA_NOINLINE void nelua_sequenceT_grow_4(nelua_sequence_elf64Sym__ptr self);
...
typedef nelua_sequence_elf64Rel_* nelua_sequence_elf64Rel__ptr;
...
static void nelua_sequence_elf64Rel___init(nelua_sequence_elf64Rel__ptr self);
static NELUA_NOINLINE void nelua_sequenceT_grow_5(nelua_sequence_elf64Rel__ptr self);
static void nelua_assert_line_31(bool cond, nlstring msg);
static NELUA_INLINE elf_elf64Rel_ptr nelua_sequence_elf64Rel____atindex(nelua_sequence_elf64Rel__ptr self, uintptr_t pos);
static void nelua_assert_line_32(bool cond, nlstring msg);
static NELUA_INLINE intptr_t nelua_sequence_elf64Rel____len(nelua_sequence_elf64Rel__ptr self);
...
static NELUA_INLINE nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
static NELUA_INLINE nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer nelua_hashmap_pointer__usize____pairs(nelua_hashmap_pointer__usize__ptr self);
...
static NELUA_INLINE nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring nelua_hashmap_string__uint32____pairs(nelua_hashmap_string__uint32__ptr self);
...
typedef void (*function_5pws3SoCsdpqTNcgP)(nelua_GC_ptr);
...
typedef void (*function_wmqEiFrJp5UDtiYF)(void*, void*);
static bool nelua_GC_step(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_wmqEiFrJp5UDtiYF finalizer, void* userdata);
...
typedef int (*function_5avZk2A2orZfHTqfr)(int, nlcstring_ptr);
...
static nelua_span_elf64Sym_ nelua_GCAllocator_spanalloc_4(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata);
static nelua_span_elf64Rel_ nelua_GCAllocator_spanalloc_5(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata);
static nelua_span_usize_ nelua_GCAllocator_spanalloc_6(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata);
...
typedef int (*function_4kohmM6xzVR44oqe8)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_4kohmM6xzVR44oqe8 closef;
};
...
static NELUA_NOINLINE nelua_sequenceimpl_elf64Sym__ptr nelua_GCAllocator_new_5(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags);
static void nelua_assert_line_66(bool cond, nlstring msg);
static NELUA_NOINLINE nelua_sequenceimpl_elf64Rel__ptr nelua_GCAllocator_new_6(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags);
...
static nelua_span_elf64Shdr_ nelua_GCAllocator_spanrealloc_4(nelua_GCAllocator_ptr self, nelua_span_elf64Shdr_ s, uintptr_t size);
static nelua_span_elf64Sym_ nelua_GCAllocator_spanrealloc_5(nelua_GCAllocator_ptr self, nelua_span_elf64Sym_ s, uintptr_t size);
static nelua_span_elf64Rel_ nelua_GCAllocator_spanrealloc_6(nelua_GCAllocator_ptr self, nelua_span_elf64Rel_ s, uintptr_t size);
...
static nelua_span_elf64Shdr_ nelua_GCAllocator_xspanrealloc_4(nelua_GCAllocator_ptr self, nelua_span_elf64Shdr_ s, uintptr_t size);
static nelua_span_elf64Sym_ nelua_GCAllocator_xspanrealloc_5(nelua_GCAllocator_ptr self, nelua_span_elf64Sym_ s, uintptr_t size);
static nelua_span_elf64Rel_ nelua_GCAllocator_xspanrealloc_6(nelua_GCAllocator_ptr self, nelua_span_elf64Rel_ s, uintptr_t size);
...
typedef int (*function_4ZzTV8GK5yCNyyQqr)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_4ZzTV8GK5yCNyyQqr closef);
...
typedef nlmulret_nlboolean_nlstring (*function_4czEKRDw7fKNpCy6B)(nelua_LinesState, nlstring);
typedef struct nlmulret_function_4czEKRDw7fKNpCy6B_nelua_LinesState_nlstring {
  function_4czEKRDw7fKNpCy6B r1;
  nelua_LinesState r2;
  nlstring r3;
} nlmulret_function_4czEKRDw7fKNpCy6B_nelua_LinesState_nlstring;
static nlmulret_function_4czEKRDw7fKNpCy6B_nelua_LinesState_nlstring nelua_filestream_lines_1(nelua_filestream_ptr self, nlniltype fmt);
...
typedef int (*function_2QhP6HKSePwghuVZq)(FILE_ptr);
...
static NELUA_INLINE intptr_t common_getProgramSize(void);
static nlstring argHandling_fileout;
static nlstring argHandling_filein;
static nlstring argHandling_execPath;
typedef struct record_36Wq65EFZbYVwb94B record_36Wq65EFZbYVwb94B;
struct record_36Wq65EFZbYVwb94B {
  bool dump;
  bool strip;
};
NELUA_STATIC_ASSERT(sizeof(record_36Wq65EFZbYVwb94B) == 2 && NELUA_ALIGNOF(record_36Wq65EFZbYVwb94B) == 1, "Nelua and C disagree on type size or align");
static record_36Wq65EFZbYVwb94B argHandling_execArgs = {.strip = true};
...
typedef struct nlmulret_nlisize_nluint64_arr3 {
  intptr_t r1;
  nluint64_arr3 r2;
} nlmulret_nlisize_nluint64_arr3;
static nlmulret_nlisize_nluint64_arr3 instr_getArgs(nlstring mnemonic, nlstring argsStr);
static NELUA_INLINE int64_t nelua_assert_bounds_nlint64(int64_t index, uintptr_t len);
static nluint8_arr4 instr_getInstr(nlstring mnemonic, nluint64_arr3 args);
...
static int64_t pseudo_infiniteSize = 0xffff;
...
static nelua_sequence_uint8_ pseudo_anonfunc(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_1(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_2(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_3(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_4(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_5(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_6(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_7(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_8(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_9(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_10(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_11(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_12(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_13(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_14(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_15(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_16(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_17(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_18(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_19(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_20(nluint64_arr3 args);
static nelua_sequence_uint8_ pseudo_anonfunc_21(nluint64_arr3 args);
...
static uint32_t elf_addSym(nlstring name, uint8_t info, uint64_t value);
static void elf_addElfRel(nlstring name, uint64_t offset);
...
static NELUA_INLINE size_t nelua_assert_narrow_nlint64_nlcsize(int64_t x);
...
elf_elf64Rel_ptr nelua_span_elf64Rel____atindex(nelua_span_elf64Rel_ self, uintptr_t i) {
...
nlmulret_function_zX6A25XsXYzcUXzZ_nelua_sequence_string__1_nlint64 nelua_ipairs_1(nelua_sequence_string__1 a) {
  return (nlmulret_function_zX6A25XsXYzcUXzZ_nelua_sequence_string__1_nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_function_3JUpn8ZeDuk6j1wG9_nlstring_ptr_nlint64 nelua_ipairs_2(nlstring_ptr a) {
  return (nlmulret_function_3JUpn8ZeDuk6j1wG9_nlstring_ptr_nlint64){nelua_ipairs_next_1, a, 0};
}
nlmulret_nlboolean_nlint64_nluint8 nelua_ipairs_next_2(nelua_sequence_uint8_ a_3, int64_t k) {
  k = (k + 1);
  if((k >= (nelua_sequence_uint8____len((&a_3)) + 1))) {
    return (nlmulret_nlboolean_nlint64_nluint8){false, 0, 0U};
  }
  nlmulret_nlboolean_nlint64_nluint8 _mulret_1;
  _mulret_1.r1 = true;
  _mulret_1.r2 = k;
  _mulret_1.r3 = (*(uint8_t*)nelua_assert_deref(nelua_sequence_uint8____atindex((&a_3), nelua_assert_narrow_nlint64_nlusize(k))));
  return _mulret_1;
}
nlmulret_function_y25EPiLYbbKkURyU_nelua_sequence_uint8__nlint64 nelua_ipairs_3(nelua_sequence_uint8_ a) {
  return (nlmulret_function_y25EPiLYbbKkURyU_nelua_sequence_uint8__nlint64){nelua_ipairs_next_2, a, 0};
}
nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer nelua_pairs_1(nelua_hashmap_pointer__usize__ptr a) {
  nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer _ret_1 = nelua_hashmap_pointer__usize____pairs(a);
  return (nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring nelua_pairs_2(nelua_hashmap_string__uint32__ptr a) {
  nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring _ret_1 = nelua_hashmap_string__uint32____pairs(a);
  return (nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
...
nelua_sequence_uint8_ nelua_sequence_uint8____convert_2(nluint8_arr1 values) {
  nelua_sequence_uint8_ self = (nelua_sequence_uint8_){0};
  nelua_sequence_uint8__reserve((&self), 1U);
  self.impl->size = 1U;
  for(uintptr_t i = 1U; i <= 1U; i += 1) {
    (*(uint8_t*)nelua_assert_deref(nelua_span_uint8____atindex(self.impl->data, i))) = values.v[nelua_assert_bounds_nlusize((i - 1), 1)];
  }
  return self;
}
nelua_sequence_uint8_ nelua_sequence_uint8____convert_3(nluint8_arr2 values) {
  nelua_sequence_uint8_ self = (nelua_sequence_uint8_){0};
  nelua_sequence_uint8__reserve((&self), 2U);
  self.impl->size = 2U;
  for(uintptr_t i = 1U; i <= 2U; i += 1) {
    (*(uint8_t*)nelua_assert_deref(nelua_span_uint8____atindex(self.impl->data, i))) = values.v[nelua_assert_bounds_nlusize((i - 1), 2)];
  }
  return self;
}
nelua_sequence_uint8_ nelua_sequence_uint8____convert_4(nluint8_arr8 values) {
  nelua_sequence_uint8_ self = (nelua_sequence_uint8_){0};
  nelua_sequence_uint8__reserve((&self), 8U);
  self.impl->size = 8U;
  for(uintptr_t i = 1U; i <= 8U; i += 1) {
    (*(uint8_t*)nelua_assert_deref(nelua_span_uint8____atindex(self.impl->data, i))) = values.v[nelua_assert_bounds_nlusize((i - 1), 8)];
  }
  return self;
}
...
void nelua_sequenceT_grow_4(nelua_sequence_elf64Sym__ptr self) {
  uintptr_t cap = 2U;
  uintptr_t curcap = self->impl->data.size;
  if(NELUA_LIKELY((curcap != 0))) {
    cap = (curcap * 2);
...
void nelua_sequence_elf64Rel___init(nelua_sequence_elf64Rel__ptr self) {
  if(NELUA_LIKELY((self->impl != NULL))) {
    return;
  }
...
void nelua_sequenceT_grow_5(nelua_sequence_elf64Rel__ptr self) {
  uintptr_t cap = 2U;
  uintptr_t curcap = self->impl->data.size;
  if(NELUA_LIKELY((curcap != 0))) {
    cap = (curcap * 2);
  ...
  if(NELUA_UNLIKELY((curcap == 0))) {
    (*(elf_elf64Rel*)nelua_assert_deref(nelua_span_elf64Rel____atindex(self->impl->data, 0U))) = (elf_elf64Rel){0};
  }
}
...
elf_elf64Rel_ptr nelua_sequence_elf64Rel____atindex(nelua_sequence_elf64Rel__ptr self, uintptr_t pos) {
  nelua_sequence_elf64Rel___init(self);
  if(NELUA_UNLIKELY((pos > self->impl->size))) {
    ...
    (*(elf_elf64Rel*)nelua_assert_deref(nelua_span_elf64Rel____atindex(self->impl->data, pos))) = (elf_elf64Rel){0};
  } else if(NELUA_UNLIKELY(((self->impl->data.size == 0) && (pos == 0)))) {
    nelua_sequenceT_grow_5(self);
  }
  return (&(*(elf_elf64Rel*)nelua_assert_deref(nelua_span_elf64Rel____atindex(self->impl->data, pos))));
}
intptr_t nelua_sequence_elf64Rel____len(nelua_sequence_elf64Rel__ptr self) {
  if(NELUA_UNLIKELY((!(self->impl != NULL)))) {
    return 0;
  }
  return (intptr_t)self->impl->size;
...
nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer nelua_hashmap_pointer__usize____pairs(nelua_hashmap_pointer__usize__ptr self) {
  return (nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring nelua_hashmap_string__uint32____pairs(nelua_hashmap_string__uint32__ptr self) {
  return (nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring){nelua_hashmap_iteratorT_6_next, (nelua_hashmap_iteratorT_6){.container = self, .index = 0xffffffffffffffffULL}, (nlstring){0}};
}
...
void nelua_GC_mark(nelua_GC_ptr self) {
  {
    nlmulret_function_3WD9agLsVsiKdpZMn_nelua_hashmap_iteratorT_1_nlpointer _asgnret_1 = nelua_pairs_1((&self->rootitems));
    function_3WD9agLsVsiKdpZMn __fornext = _asgnret_1.r1;
  ...
  if((self->stackbottom != 0)) {
    volatile function_5pws3SoCsdpqTNcgP scanstack = nelua_GC_scanstack;
    scanstack(self);
  }
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  {
    nlmulret_function_4vSM2TPoV7UbANK5U_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_4vSM2TPoV7UbANK5U __fornext = _asgnret_1.r1;
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&nelua_arg), 8U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_usageStr), 16U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&common_program), 8U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&argHandling_fileout), 16U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&argHandling_filein), 16U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&argHandling_execPath), 16U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&label_labels), 48U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&instr_instruction), 48U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&pseudo_pseudoInstr), 48U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_curLabel), 16U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_file), 8U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_cfile), 8U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&argHandling_opt), 48U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&elf_shdrs), 8U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&elf_syms), 8U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&elf_rels), 8U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&elf_names), 48U, 131072U, (function_wmqEiFrJp5UDtiYF)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_wmqEiFrJp5UDtiYF finalizer, void* userdata) {
  if(NELUA_UNLIKELY((!(ptr != NULL)))) {
    return;
  }
  ...
  if(NELUA_LIKELY((!nelua_hasflag(flags, 131072U)))) {
    ...
    nelua_assert_line_58(((finalizer == (function_wmqEiFrJp5UDtiYF)NULL) && (userdata == (void*)NULL)), ((nlstring){(uint8_t*)"attempt to register a root pointer with finalizer", 49}));
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_5avZk2A2orZfHTqfr inner_main = nelua_main;
...
nelua_span_elf64Sym_ nelua_GCAllocator_spanalloc_4(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  uintptr_t flags_8 = 262144U;
  nelua_GCFinalizerCallback finalizer_5 = (nelua_GCFinalizerCallback)NULL;
  void* userdata_5 = (void*)NULL;
  if(NELUA_LIKELY((size > 0))) {
    elf_elf64Sym_arr0_ptr data = ((elf_elf64Sym_arr0_ptr)nelua_GCAllocator_alloc_3(self, (size * 24), flags_8, finalizer_5, userdata_5));
...
nelua_span_elf64Rel_ nelua_GCAllocator_spanalloc_5(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  uintptr_t flags_9 = 262144U;
  nelua_GCFinalizerCallback finalizer_6 = (nelua_GCFinalizerCallback)NULL;
  void* userdata_6 = (void*)NULL;
  if(NELUA_LIKELY((size > 0))) {
    elf_elf64Rel_arr0_ptr data = ((elf_elf64Rel_arr0_ptr)nelua_GCAllocator_alloc_3(self, (size * 16), flags_9, finalizer_6, userdata_6));
    if(NELUA_LIKELY((data != ((elf_elf64Rel_arr0_ptr)NULL)))) {
      return (nelua_span_elf64Rel_){.data = data, .size = size};
    }
  }
  return (nelua_span_elf64Rel_){0};
}
nelua_span_usize_ nelua_GCAllocator_spanalloc_6(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
...
nelua_sequenceimpl_elf64Shdr__ptr nelua_GCAllocator_new_4(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_65((ptr != ((nelua_sequenceimpl_elf64Shdr__ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
nelua_sequenceimpl_elf64Sym__ptr nelua_GCAllocator_new_5(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  nelua_GCFinalizerCallback finalizer = (nelua_GCFinalizerCallback)NULL;
  ...
  nelua_assert_line_66((ptr != ((nelua_sequenceimpl_elf64Sym__ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
nelua_sequenceimpl_elf64Rel__ptr nelua_GCAllocator_new_6(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  nelua_GCFinalizerCallback finalizer = (nelua_GCFinalizerCallback)NULL;
  nelua_sequenceimpl_elf64Rel__ptr ptr;
  ptr = ((nelua_sequenceimpl_elf64Rel__ptr)nelua_GCAllocator_alloc0_1((&nelua_gc_allocator), 24U, NELUA_NIL, finalizer, (void*)NULL));
  nelua_assert_line_67((ptr != ((nelua_sequenceimpl_elf64Rel__ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
nelua_span_elf64Shdr_ nelua_GCAllocator_spanrealloc_4(nelua_GCAllocator_ptr self, nelua_span_elf64Shdr_ s, uintptr_t size) {
  if(NELUA_UNLIKELY(((s.size == 0) && (size > 0)))) {
...
nelua_span_elf64Sym_ nelua_GCAllocator_spanrealloc_5(nelua_GCAllocator_ptr self, nelua_span_elf64Sym_ s, uintptr_t size) {
  if(NELUA_UNLIKELY(((s.size == 0) && (size > 0)))) {
...
nelua_span_elf64Rel_ nelua_GCAllocator_spanrealloc_6(nelua_GCAllocator_ptr self, nelua_span_elf64Rel_ s, uintptr_t size) {
  if(NELUA_UNLIKELY(((s.size == 0) && (size > 0)))) {
    s = nelua_GCAllocator_spanalloc_5(self, NELUA_NIL, size, NELUA_NIL, NELUA_NIL, NELUA_NIL);
    return s;
  }
  elf_elf64Rel_arr0_ptr p = ((elf_elf64Rel_arr0_ptr)nelua_GCAllocator_realloc(self, (void*)s.data, (size * 16), (s.size * 16)));
  if(NELUA_UNLIKELY(((size > 0) && (p == ((elf_elf64Rel_arr0_ptr)NULL))))) {
    return s;
  }
  s.data = p;
  s.size = size;
...
nelua_span_elf64Shdr_ nelua_GCAllocator_xspanrealloc_4(nelua_GCAllocator_ptr self, nelua_span_elf64Shdr_ s, uintptr_t size) {
...
nelua_span_elf64Sym_ nelua_GCAllocator_xspanrealloc_5(nelua_GCAllocator_ptr self, nelua_span_elf64Sym_ s, uintptr_t size) {
...
nelua_span_elf64Rel_ nelua_GCAllocator_xspanrealloc_6(nelua_GCAllocator_ptr self, nelua_span_elf64Rel_ s, uintptr_t size) {
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_4ZzTV8GK5yCNyyQqr closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_4kohmM6xzVR44oqe8)NULL;
  if((res != 0)) {
    nlmulret_nlstring_nlint64 _ret_1 = nelua_geterrno();
...
nlmulret_function_4czEKRDw7fKNpCy6B_nelua_LinesState_nlstring nelua_filestream_lines_1(nelua_filestream_ptr self, nlniltype fmt) {
  nlstring fmt_1 = ((nlstring){(uint8_t*)"l", 1});
  return (nlmulret_function_4czEKRDw7fKNpCy6B_nelua_LinesState_nlstring){nelua_lines_next, (nelua_LinesState){.file = (*(nelua_filestream*)nelua_assert_deref(self)), .fmt = fmt_1}, (nlstring){0}};
}
...
nlmulret_nelua_filestream_nlstring_nlint64 nelua_io_popen_1(nlstring prog, nlniltype mode) {
  ...
  FILE_ptr fp = NULL;
  function_2QhP6HKSePwghuVZq closef = NULL;
#if defined(_WIN32)
...
intptr_t common_getProgramSize(void) {
  return nelua_sequence_uint8____len((&common_program));
}
...
void nelua_require_argHandling(nlniltype modname) {
  ...
  {
    nlmulret_function_zX6A25XsXYzcUXzZ_nelua_sequence_string__1_nlint64 _asgnret_1 = nelua_ipairs_1(nelua_arg);
    function_zX6A25XsXYzcUXzZ __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = i;
      {
        ...
        {
          nlmulret_function_3JUpn8ZeDuk6j1wG9_nlstring_ptr_nlint64 _asgnret_3 = nelua_ipairs_2((&(*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize(i))))));
          function_3JUpn8ZeDuk6j1wG9 __fornext_1 = _asgnret_3.r1;
...
nlmulret_nlisize_nluint64_arr3 instr_getArgs(nlstring mnemonic, nlstring argsStr) {
  intptr_t size = 0;
  nluint64_arr3 args = (nluint64_arr3){0};
  ...
  for(int64_t i = 0; i < 3; i += 1) {
    ...
    if(nelua_nlstring_match_1(str, ((nlstring){(uint8_t*)"^-?%d*$", 7}), NELUA_NIL).r1) {
      args.v[nelua_assert_bounds_nlint64(i, 3)] = (uint64_t)nelua_tointeger_1(str, NELUA_NIL);
      ...
      if(((*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), str))).length == -1)) {
        args.v[nelua_assert_bounds_nlint64(i, 3)] = (*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), str))).value;
      } else {
        args.v[nelua_assert_bounds_nlint64(i, 3)] = (uint64_t)(int64_t)((*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), str))).value - common_getProgramSize());
      }
      ...
      if(nelua_hashmap_string__V__has((&label_labels), label)) {
        args.v[nelua_assert_bounds_nlint64(i, 3)] = (uint64_t)(*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), label))).length;
      }
    }
  }
  return (nlmulret_nlisize_nluint64_arr3){size, args};
}
...
nluint8_arr4 instr_getInstr(nlstring mnemonic, nluint64_arr3 args) {
  if((!nelua_hashmap_string__V__1_has((&instr_instruction), mnemonic))) {
  ...
  switch(curInstr.type) {
    ...
    case 1: {
      instr = (instr | (uint32_t)(args.v[0] << 7));
      instr = (instr | (uint32_t)(args.v[1] << 15));
      instr = (instr | (uint32_t)(args.v[2] << 20));
      instr = (instr | ((uint32_t)curInstr.func3 << 12));
      instr = (instr | ((uint32_t)curInstr.func7 << 25));
      break;
    }
    case 3: {
      instr = (instr | (uint32_t)(args.v[0] << 15));
      instr = (instr | (uint32_t)(args.v[1] << 20));
      instr = (instr | (uint32_t)((args.v[2] & 0x1f) << 7));
      instr = (instr | (uint32_t)((args.v[2] >> 5) << 25));
      instr = (instr | ((uint32_t)curInstr.func3 << 12));
      break;
    }
    case 4: {
      instr = (instr | (uint32_t)(args.v[0] << 15));
      instr = (instr | (uint32_t)(args.v[1] << 20));
      instr = (instr | (uint32_t)((args.v[2] & 0x1e) << 7));
      instr = (instr | (uint32_t)((args.v[2] & 0x7e0) << 20));
      instr = (instr | (uint32_t)((args.v[2] & 0x800) >> 4));
      instr = (instr | (uint32_t)((args.v[2] & 0x1000) << 19));
      instr = (instr | ((uint32_t)curInstr.func3 << 12));
      break;
    }
    case 5: {
      instr = (instr | (uint32_t)(args.v[0] << 7));
      instr = (instr | (uint32_t)(args.v[1] << 12));
      break;
    }
    case 6: {
      instr = (instr | (uint32_t)(args.v[0] << 7));
      instr = (instr | (uint32_t)((args.v[1] & 0x7fe) << 20));
      instr = (instr | (uint32_t)(((args.v[1] >> 11) & 1) << 20));
      instr = (instr | (uint32_t)(((args.v[1] >> 12) & 0xff) << 12));
      instr = (instr | (uint32_t)((args.v[1] >> 20) << 31));
      break;
    }
  }
...
nelua_sequence_uint8_ pseudo_anonfunc(nluint64_arr3 args) {
  if((args.v[1] <= 0xfff)) {
    return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"addi", 4}), (nluint64_arr3){{args.v[0], 0U, args.v[1]}}));
  } else {
    return ({
      nelua_sequence_uint8_ _tmp1 = nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"lui", 3}), (nluint64_arr3){{args.v[0], (args.v[1] >> 12)}}));
      nelua_sequence_uint8_ _tmp2 = nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"addiw", 5}), (nluint64_arr3){{args.v[0], args.v[0], args.v[1]}}));
      pseudo_concat(_tmp1, _tmp2);
    });
  }
}
nelua_sequence_uint8_ pseudo_anonfunc_1(nluint64_arr3 args) {
  uint64_t val = 0U;
  if(((int64_t)args.v[1] < 0)) {
    val = ((~args.v[1]) >> 12);
  } else {
    val = (args.v[1] >> 12);
  }
  return ({
    nelua_sequence_uint8_ _tmp1 = nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"auipc", 5}), (nluint64_arr3){{args.v[0], val}}));
    nelua_sequence_uint8_ _tmp2 = nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"addi", 4}), (nluint64_arr3){{args.v[0], args.v[0], args.v[1]}}));
    pseudo_concat(_tmp1, _tmp2);
  });
}
nelua_sequence_uint8_ pseudo_anonfunc_2(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"addi", 4}), (nluint64_arr3){{args.v[0], args.v[1], 0U}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_3(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"xori", 4}), (nluint64_arr3){{args.v[0], args.v[1], 0xfffU}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_4(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"sub", 3}), (nluint64_arr3){{args.v[0], 0U, args.v[1]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_5(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"blt", 3}), (nluint64_arr3){{args.v[1], args.v[0], args.v[2]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_6(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"bge", 3}), (nluint64_arr3){{args.v[1], args.v[0], args.v[2]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_7(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"bltu", 4}), (nluint64_arr3){{args.v[1], args.v[0], args.v[2]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_8(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"bgeu", 4}), (nluint64_arr3){{args.v[1], args.v[0], args.v[2]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_9(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"beq", 3}), (nluint64_arr3){{args.v[0], 0U, args.v[1]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_10(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"bne", 3}), (nluint64_arr3){{args.v[0], 0U, args.v[1]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_11(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"bge", 3}), (nluint64_arr3){{args.v[0], 0U, args.v[1]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_12(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"bge", 3}), (nluint64_arr3){{0U, args.v[0], args.v[1]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_13(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"blt", 3}), (nluint64_arr3){{0U, args.v[0], args.v[1]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_14(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"jal", 3}), (nluint64_arr3){{0U, args.v[0]}}));
}
nelua_sequence_uint8_ pseudo_anonfunc_15(nluint64_arr3 args) {
  if((args.v[1] <= 0xfff)) {
    return nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"jal", 3}), (nluint64_arr3){{1U, args.v[0]}}));
  } else {
    return ({
      nelua_sequence_uint8_ _tmp1 = nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"auipc", 5}), (nluint64_arr3){{1U, (args.v[0] >> 12)}}));
      nelua_sequence_uint8_ _tmp2 = nelua_sequence_uint8____convert_1(instr_getInstr(((nlstring){(uint8_t*)"jal", 3}), (nluint64_arr3){{1U, args.v[0]}}));
      pseudo_concat(_tmp1, _tmp2);
    });
  }
}
nelua_sequence_uint8_ pseudo_anonfunc_16(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1((nluint8_arr4){{0x67U, 0x80U, 0U, 0U}});
}
nelua_sequence_uint8_ pseudo_anonfunc_17(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1((nluint8_arr4){{0x13U, 0U, 0U, 0U}});
}
nelua_sequence_uint8_ pseudo_anonfunc_18(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_2((nluint8_arr1){{(uint8_t)(args.v[0] & 0xff)}});
}
nelua_sequence_uint8_ pseudo_anonfunc_19(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_3((nluint8_arr2){{(uint8_t)(args.v[0] & 0xff), (uint8_t)((args.v[0] >> 8) & 0xff)}});
}
nelua_sequence_uint8_ pseudo_anonfunc_20(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_1((nluint8_arr4){{(uint8_t)(args.v[0] & 0xff), (uint8_t)((args.v[0] >> 8) & 0xff), (uint8_t)((args.v[0] >> 16) & 0xff), (uint8_t)((args.v[0] >> 24) & 0xff)}});
}
nelua_sequence_uint8_ pseudo_anonfunc_21(nluint64_arr3 args) {
  return nelua_sequence_uint8____convert_4((nluint8_arr8){{(uint8_t)(args.v[0] & 0xff), (uint8_t)((args.v[0] >> 8) & 0xff), (uint8_t)((args.v[0] >> 16) & 0xff), (uint8_t)((args.v[0] >> 24) & 0xff), (uint8_t)((args.v[0] >> 32) & 0xff), (uint8_t)((args.v[0] >> 40) & 0xff), (uint8_t)((args.v[0] >> 48) & 0xff), (uint8_t)((args.v[0] >> 56) & 0xff)}});
}
void nelua_require_pseudo(nlniltype modname) {
  ...
  (*(nelua_V_5*)nelua_assert_deref(nelua_hashmap_string__V__2___atindex((&pseudo_pseudoInstr), ((nlstring){(uint8_t*)"db", 2})))) = (nelua_V_5){(uint16_t)pseudo_infiniteSize, pseudo_anonfunc_18};
  (*(nelua_V_5*)nelua_assert_deref(nelua_hashmap_string__V__2___atindex((&pseudo_pseudoInstr), ((nlstring){(uint8_t*)"dh", 2})))) = (nelua_V_5){(uint16_t)pseudo_infiniteSize, pseudo_anonfunc_19};
  (*(nelua_V_5*)nelua_assert_deref(nelua_hashmap_string__V__2___atindex((&pseudo_pseudoInstr), ((nlstring){(uint8_t*)"dw", 2})))) = (nelua_V_5){(uint16_t)pseudo_infiniteSize, pseudo_anonfunc_20};
  (*(nelua_V_5*)nelua_assert_deref(nelua_hashmap_string__V__2___atindex((&pseudo_pseudoInstr), ((nlstring){(uint8_t*)"dd", 2})))) = (nelua_V_5){(uint16_t)pseudo_infiniteSize, pseudo_anonfunc_21};
}
...
uint32_t elf_addSym(nlstring name, uint8_t info, uint64_t value) {
  ...
  (*(elf_elf64Sym*)nelua_assert_deref(nelua_sequence_elf64Sym____atindex((&elf_syms), nelua_assert_narrow_nlisize_nlusize((nelua_sequence_elf64Sym____len((&elf_syms)) + 1))))) = (elf_elf64Sym){nameN, info, 0U, (uint16_t)shindex, value, 0U};
  return (uint32_t)ret;
}
void elf_addElfRel(nlstring name, uint64_t offset) {
  uint32_t symN = elf_addSym(name, 16U, 0U);
  (*(elf_elf64Rel*)nelua_assert_deref(nelua_sequence_elf64Rel____atindex((&elf_rels), nelua_assert_narrow_nlisize_nlusize((nelua_sequence_elf64Rel____len((&elf_rels)) + 1))))) = (elf_elf64Rel){offset, (((uint64_t)symN << 32) | 19)};
}
void elf_addShdr(nlstring name, uint64_t sType, uint32_t flag, uint64_t size, uint64_t offset) {
  ...
  intptr_t info = 0;
  if((sType == 2)) {
    link = (nelua_sequence_elf64Shdr____len((&elf_shdrs)) + 1);
    eSize = 24;
    info = (nelua_sequence_elf64Sym____len((&elf_syms)) - 1);
  }
  if((sType == 9)) {
    link = (nelua_sequence_elf64Shdr____len((&elf_shdrs)) + 1);
    eSize = 16;
...
size_t nelua_assert_narrow_nlint64_nlcsize(int64_t x) {
  if(NELUA_UNLIKELY(x < 0)) {
    nelua_panic_cstring("narrow casting from int64 to csize failed");
  }
  return (size_t)x;
}
void elf_writeToFile(nlstring filename, nelua_sequence_uint8_ program_1, uint64_t start) {
  ...
  if(object) {
    ...
    strip = argHandling_execArgs.strip;
  }
  int64_t phdrSize = (object ? 0 : 1);
  if(object) {
    elf_addShdr(((nlstring){(uint8_t*)"", 0}), 0U, 0U, 0U, 0U);
  }
  elf_addShdr(((nlstring){(uint8_t*)".text", 5}), 1U, 7U, nelua_assert_narrow_nlisize_nluint64(common_getProgramSize()), 384U);
  if(object) {
    elf_addShdr(((nlstring){(uint8_t*)".rel", 4}), 9U, 0U, nelua_assert_narrow_nlisize_nluint64((nelua_sequence_elf64Rel____len((&elf_rels)) * 16)), nelua_assert_narrow_nlisize_nluint64(((384 + common_getProgramSize()) + (24 * nelua_sequence_elf64Sym____len((&elf_syms))))));
    (*(elf_elf64Shdr*)nelua_assert_deref(nelua_sequence_elf64Shdr____atindex((&elf_shdrs), nelua_assert_narrow_nlisize_nlusize(nelua_sequence_elf64Shdr____len((&elf_shdrs)))))).sh_addr = 0U;
    elf_addShdr(((nlstring){(uint8_t*)".symtab", 7}), 2U, 0U, nelua_assert_narrow_nlisize_nluint64((24 * nelua_sequence_elf64Sym____len((&elf_syms)))), nelua_assert_narrow_nlisize_nluint64((384 + common_getProgramSize())));
    (*(elf_elf64Shdr*)nelua_assert_deref(nelua_sequence_elf64Shdr____atindex((&elf_shdrs), nelua_assert_narrow_nlisize_nlusize(nelua_sequence_elf64Shdr____len((&elf_shdrs)))))).sh_addr = 0U;
  }
  if((!strip)) {
    elf_addShdr(((nlstring){(uint8_t*)".strtab", 7}), 3U, 0U, 0U, nelua_assert_narrow_nlisize_nluint64((((((64 + (64 * (nelua_sequence_elf64Shdr____len((&elf_shdrs)) + 1))) + common_getProgramSize()) + (phdrSize * 56)) + (24 * nelua_sequence_elf64Sym____len((&elf_syms)))) + (16 * nelua_sequence_elf64Rel____len((&elf_rels))))));
    (*(elf_elf64Shdr*)nelua_assert_deref(nelua_sequence_elf64Shdr____atindex((&elf_shdrs), nelua_assert_narrow_nlisize_nlusize(nelua_sequence_elf64Shdr____len((&elf_shdrs)))))).sh_addr = 0U;
  ...
  elf_elf64Ehdr header = (elf_elf64Ehdr){{0x7fU, 0x45U, 0x4cU, 0x46U, 2U, 1U, 1U, 0U}, (uint16_t)((object == true) ? 1 : 2), 243U, 1U, (uint64_t)(int64_t)((int64_t)((64 + elf_addressOffset) + (nelua_sequence_elf64Shdr____len((&elf_shdrs)) * 64)) + start), (uint64_t)((phdrSize > 0) ? ((64 + common_getProgramSize()) + (nelua_sequence_elf64Shdr____len((&elf_shdrs)) * 64)) : 0), 64U, 4U, 64U, (uint16_t)((phdrSize > 0) ? 56 : 0), (uint16_t)phdrSize, 64U, (uint16_t)nelua_sequence_elf64Shdr____len((&elf_shdrs)), (uint16_t)((strip == false) ? (nelua_sequence_elf64Shdr____len((&elf_shdrs)) - 1) : 0)};
  ...
  for(intptr_t i = 1, _end = nelua_sequence_elf64Sym____len((&elf_syms)); i <= _end; i += 1) {
    fwrite((void*)(&(*(elf_elf64Sym*)nelua_assert_deref(nelua_sequence_elf64Sym____atindex((&elf_syms), nelua_assert_narrow_nlisize_nlusize(i))))), 1U, 24U, (void*)file);
  }
  for(intptr_t i = 1, _end = nelua_sequence_elf64Rel____len((&elf_rels)); i <= _end; i += 1) {
    fwrite((void*)(&(*(elf_elf64Rel*)nelua_assert_deref(nelua_sequence_elf64Rel____atindex((&elf_rels), nelua_assert_narrow_nlisize_nlusize(i))))), 1U, 16U, (void*)file);
  }
  if((!object)) {
    fwrite((void*)(&ph), nelua_assert_narrow_nlint64_nlcsize(phdrSize), 56U, (void*)file);
  }
  if((!strip)) {
    {
      nlmulret_function_yo2zyTZVDd3HZ8nr_nelua_hashmap_iteratorT_6_nlstring _asgnret_1 = nelua_pairs_2((&elf_names));
      function_yo2zyTZVDd3HZ8nr __fornext = _asgnret_1.r1;
...
void nelua_require_elf(nlniltype modname) {
  ...
  elf_addSym(((nlstring){(uint8_t*)"", 0}), 0U, 0U);
  elf_addSym(((nlstring){(uint8_t*)".text", 5}), 3U, 0U);
}
nlstring main_parseString(nlstring str) {
  bool escape = false;
  nlstring retStr = ((nlstring){(uint8_t*)"", 0});
  {
    nlmulret_function_3JUpn8ZeDuk6j1wG9_nlstring_ptr_nlint64 _asgnret_1 = nelua_ipairs_2((&str));
    function_3JUpn8ZeDuk6j1wG9 __fornext = _asgnret_1.r1;
...
int nelua_main(int argc, char** argv) {
  ...
  {
    nlmulret_function_4czEKRDw7fKNpCy6B_nelua_LinesState_nlstring _asgnret_1 = nelua_filestream_lines_1((&main_file), NELUA_NIL);
    function_4czEKRDw7fKNpCy6B __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = line;
      {
        if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"#", 1}), NELUA_NIL).r1) {
          continue;
        }
        if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%s*%S*:%s*$", 11}), NELUA_NIL).r1) {
          ...
          if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"[\"']", 4}), NELUA_NIL).r1) {
            nelua_sequence_string_ args = ({
              nlmulret_nlboolean_nelua_sequence_string_ _tmp1 = nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"(%S+)%s*=%s*\"(.*)\"", 18}), NELUA_NIL);
              nelua_select_1(NELUA_NIL, _tmp1.r1, _tmp1.r2);
            });
            ...
            intptr_t len = nelua_nlstring___len(str);
            ...
            main_addressLabel = (int64_t)(main_addressLabel + nelua_nlstring___len(str));
            if((nelua_assert_imod_nlisize(nelua_nlstring___len(str), 2) == 1)) {
            ...
            nelua_sequence_string_ args = ({
              nlmulret_nlboolean_nelua_sequence_string_ _tmp1 = nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%s*(%S*)%s*=%s*(.*)", 19}), NELUA_NIL);
              nelua_select_1(NELUA_NIL, _tmp1.r1, _tmp1.r2);
            });
          ...
          if(nelua_hashmap_string__V__1_has((&instr_instruction), mnemonic)) {
            ...
            nlmulret_nlisize_nluint64_arr3 _asgnret_4 = instr_getArgs(mnemonic, (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 2U))));
            nluint64_arr3 args = _asgnret_4.r2;
            length = nelua_sequence_uint8____len(NELUA_LITERAL_REF(nelua_sequence_uint8_, ((*(nelua_V_5*)nelua_assert_deref(nelua_hashmap_string__V__2___atindex((&pseudo_pseudoInstr), mnemonic))).assemble(args))));
          }
  ...
  {
    nlmulret_function_4czEKRDw7fKNpCy6B_nelua_LinesState_nlstring _asgnret_5 = nelua_filestream_lines_1((&main_file), NELUA_NIL);
    function_4czEKRDw7fKNpCy6B __fornext = _asgnret_5.r1;
    ...
    while(true) {
      ...
      __fornextit = line;
      {
        ...
        if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%S", 2}), NELUA_NIL).r1) {
          ...
          nlstring mnemonic = nelua_nlstring_lower((*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 1U))));
          nlmulret_nlisize_nluint64_arr3 _asgnret_8 = instr_getArgs(mnemonic, (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 2U))));
          nluint64_arr3 args = _asgnret_8.r2;
          bool obj = true;
          if(((nelua_nlstring___eq(mnemonic, ((nlstring){(uint8_t*)"call", 4})) && (!nelua_hashmap_string__V__has((&label_labels), (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 2U)))))) && obj)) {
            elf_addElfRel((*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 2U))), nelua_assert_narrow_nlisize_nluint64(common_getProgramSize()));
          }
          if(nelua_hashmap_string__V__1_has((&instr_instruction), mnemonic)) {
            ...
            for(intptr_t i = 1, _end = nelua_sequence_uint8____len((&bytes)); i <= _end; i += 1) {
              (*(uint8_t*)nelua_assert_deref(nelua_sequence_uint8____atindex((&common_program), nelua_assert_narrow_nlisize_nlusize((nelua_sequence_uint8____len((&common_program)) + 1))))) = (*(uint8_t*)nelua_assert_deref(nelua_sequence_uint8____atindex((&bytes), nelua_assert_narrow_nlisize_nlusize(i))));
            }
          }
        }
  ...
  if(argHandling_execArgs.dump) {
    {
      nlmulret_function_y25EPiLYbbKkURyU_nelua_sequence_uint8__nlint64 _asgnret_9 = nelua_ipairs_3(common_program);
      function_y25EPiLYbbKkURyU __fornext = _asgnret_9.r1;
      nelua_sequence_uint8_ __forstate = _asgnret_9.r2;
      int64_t __fornextit = _asgnret_9.r3;
      while(true) {
        nlmulret_nlboolean_nlint64_nluint8 _asgnret_10 = __fornext(__forstate, __fornextit);
        bool __forcont = _asgnret_10.r1;
        int64_t _ = _asgnret_10.r2;
        uint8_t v = _asgnret_10.r3;
        if((!__forcont)) {
          break;
        }
        __fornextit = _;
