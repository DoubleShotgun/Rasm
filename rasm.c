...
/* Compile hash: 2Ri2F9fY2AmBPtGXo8ZktYt1ptx5 */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
NELUA_STATIC_ASSERT(sizeof(nelua_V_2) == 24 && NELUA_ALIGNOF(nelua_V_2) == 8, "Nelua and C disagree on type size or align");
...
NELUA_STATIC_ASSERT(sizeof(nelua_hashmapnode_uint8__V_) == 48 && NELUA_ALIGNOF(nelua_hashmapnode_uint8__V_) == 8, "Nelua and C disagree on type size or align");
...
typedef struct nelua_sequence_uint32_ nelua_sequence_uint32_;
typedef struct nelua_sequenceimpl_uint32_ nelua_sequenceimpl_uint32_;
typedef nelua_sequenceimpl_uint32_* nelua_sequenceimpl_uint32__ptr;
typedef struct nelua_GCAllocator nelua_GCAllocator;
struct nelua_GCAllocator {};
struct nelua_sequence_uint32_ {
  nelua_sequenceimpl_uint32__ptr impl;
  nelua_GCAllocator allocator;
};
NELUA_STATIC_ASSERT(sizeof(nelua_sequence_uint32_) == 8 && NELUA_ALIGNOF(nelua_sequence_uint32_) == 8, "Nelua and C disagree on type size or align");
typedef struct NELUA_MAYALIAS nluint32_arr3 {uint32_t v[3];} nluint32_arr3;
typedef union NELUA_MAYALIAS nluint32_arr3_cast {nluint32_arr3 a; uint32_t p[3];} nluint32_arr3_cast;
NELUA_STATIC_ASSERT(sizeof(nluint32_arr3) == 12 && NELUA_ALIGNOF(nluint32_arr3) == 4, "Nelua and C disagree on type size or align");
typedef nelua_sequence_uint32_ (*function_4yhDd94cnXzYYd8XJ)(nluint32_arr3);
struct nelua_V_5 {
  uint32_t argc;
  function_4yhDd94cnXzYYd8XJ assemble;
};
...
struct nelua_sequenceimpl_uint32_ {
  nelua_span_uint32_ data;
  uintptr_t size;
};
NELUA_STATIC_ASSERT(sizeof(nelua_sequenceimpl_uint32_) == 24 && NELUA_ALIGNOF(nelua_sequenceimpl_uint32_) == 8, "Nelua and C disagree on type size or align");
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_2JzBeaBv9DUsZfMnm)(nelua_sequence_string__1, int64_t);
...
typedef struct nlmulret_function_2JzBeaBv9DUsZfMnm_nelua_sequence_string__1_nlint64 {
  function_2JzBeaBv9DUsZfMnm r1;
  nelua_sequence_string__1 r2;
  int64_t r3;
} nlmulret_function_2JzBeaBv9DUsZfMnm_nelua_sequence_string__1_nlint64;
static NELUA_INLINE nlmulret_function_2JzBeaBv9DUsZfMnm_nelua_sequence_string__1_nlint64 nelua_ipairs_1(nelua_sequence_string__1 a);
static NELUA_INLINE nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string__1 a_1, int64_t k);
...
typedef nlmulret_nlboolean_nlint64_nluint8 (*function_2vLzwm7GgVbixrMzR)(nlstring_ptr, int64_t);
typedef struct nlmulret_function_2vLzwm7GgVbixrMzR_nlstring_ptr_nlint64 {
  function_2vLzwm7GgVbixrMzR r1;
  nlstring_ptr r2;
  int64_t r3;
} nlmulret_function_2vLzwm7GgVbixrMzR_nlstring_ptr_nlint64;
static NELUA_INLINE nlmulret_function_2vLzwm7GgVbixrMzR_nlstring_ptr_nlint64 nelua_ipairs_2(nlstring_ptr a);
static NELUA_INLINE nlmulret_nlboolean_nlint64_nluint8 nelua_ipairs_next_1(nlstring_ptr a_2, int64_t k);
typedef struct nlmulret_nlboolean_nlint64_nluint32 {
  bool r1;
  int64_t r2;
  uint32_t r3;
} nlmulret_nlboolean_nlint64_nluint32;
typedef nlmulret_nlboolean_nlint64_nluint32 (*function_2xeznntUSZa5dDBQC)(nelua_sequence_uint32_, int64_t);
typedef struct nlmulret_function_2xeznntUSZa5dDBQC_nelua_sequence_uint32__nlint64 {
  function_2xeznntUSZa5dDBQC r1;
  nelua_sequence_uint32_ r2;
  int64_t r3;
} nlmulret_function_2xeznntUSZa5dDBQC_nelua_sequence_uint32__nlint64;
static NELUA_INLINE nlmulret_function_2xeznntUSZa5dDBQC_nelua_sequence_uint32__nlint64 nelua_ipairs_3(nelua_sequence_uint32_ a);
static NELUA_INLINE nlmulret_nlboolean_nlint64_nluint32 nelua_ipairs_next_2(nelua_sequence_uint32_ a_3, int64_t k);
...
typedef nlmulret_nlboolean_nlpointer_nlusize (*function_45P6aQnHsd7fUeWma)(nelua_hashmap_iteratorT_1_ptr, void*);
...
typedef struct nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer {
  function_45P6aQnHsd7fUeWma r1;
  nelua_hashmap_iteratorT_1 r2;
  void* r3;
} nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer;
static NELUA_INLINE nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer nelua_pairs_1(nelua_hashmap_pointer__usize__ptr a);
...
typedef nlmulret_nlboolean_nlstring_nluint32 (*function_2XS1go9rn2UatzpfF)(nelua_hashmap_iteratorT_6_ptr, nlstring);
...
typedef struct nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring {
  function_2XS1go9rn2UatzpfF r1;
  nelua_hashmap_iteratorT_6 r2;
  nlstring r3;
} nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring;
static NELUA_INLINE nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring nelua_pairs_2(nelua_hashmap_string__uint32__ptr a);
...
typedef nlmulret_nlboolean_nlpointer_nelua_GCItem_ptr (*function_4nXR3uaisqxAY6BF8)(nelua_hashmap_iteratorT_ptr, void*);
...
typedef struct nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer {
  function_4nXR3uaisqxAY6BF8 r1;
  nelua_hashmap_iteratorT r2;
  void* r3;
} nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer;
static NELUA_INLINE nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a);
...
static NELUA_INLINE nelua_sequence_string_ nelua_select_1(nlniltype index, bool __arg1, nelua_sequence_string_ __arg2);
...
typedef nelua_sequence_uint32_* nelua_sequence_uint32__ptr;
static void nelua_sequence_uint32___init(nelua_sequence_uint32__ptr self);
static void nelua_sequence_uint32__reserve(nelua_sequence_uint32__ptr self, uintptr_t n);
static NELUA_NOINLINE void nelua_sequenceT_grow_2(nelua_sequence_uint32__ptr self);
static void nelua_assert_line_24(bool cond, nlstring msg);
static NELUA_INLINE nluint32_ptr nelua_sequence_uint32____atindex(nelua_sequence_uint32__ptr self, uintptr_t pos);
static void nelua_assert_line_25(bool cond, nlstring msg);
static NELUA_INLINE intptr_t nelua_sequence_uint32____len(nelua_sequence_uint32__ptr self);
typedef struct NELUA_MAYALIAS nluint32_arr1 {uint32_t v[1];} nluint32_arr1;
typedef union NELUA_MAYALIAS nluint32_arr1_cast {nluint32_arr1 a; uint32_t p[1];} nluint32_arr1_cast;
NELUA_STATIC_ASSERT(sizeof(nluint32_arr1) == 4 && NELUA_ALIGNOF(nluint32_arr1) == 4, "Nelua and C disagree on type size or align");
static NELUA_INLINE nelua_sequence_uint32_ nelua_sequence_uint32____convert_1(nluint32_arr1 values);
static NELUA_INLINE uintptr_t nelua_assert_bounds_nlusize(uintptr_t index, uintptr_t len);
typedef struct NELUA_MAYALIAS nluint32_arr2 {uint32_t v[2];} nluint32_arr2;
typedef union NELUA_MAYALIAS nluint32_arr2_cast {nluint32_arr2 a; uint32_t p[2];} nluint32_arr2_cast;
NELUA_STATIC_ASSERT(sizeof(nluint32_arr2) == 8 && NELUA_ALIGNOF(nluint32_arr2) == 4, "Nelua and C disagree on type size or align");
static NELUA_INLINE nelua_sequence_uint32_ nelua_sequence_uint32____convert_2(nluint32_arr2 values);
...
static NELUA_NOINLINE void nelua_sequenceT_grow_3(nelua_sequence_elf64Shdr__ptr self);
...
static void nelua_assert_line_28(bool cond);
...
static NELUA_INLINE nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self);
...
static void nelua_assert_line_30(bool cond);
...
static NELUA_INLINE nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer nelua_hashmap_pointer__usize____pairs(nelua_hashmap_pointer__usize__ptr self);
...
static void nelua_assert_line_32(bool cond);
...
static void nelua_assert_line_34(bool cond);
...
static void nelua_assert_line_36(bool cond);
...
static void nelua_assert_line_38(bool cond);
...
static void nelua_assert_line_40(bool cond);
...
static NELUA_INLINE nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring nelua_hashmap_string__uint32____pairs(nelua_hashmap_string__uint32__ptr self);
...
typedef void (*function_RGDckgJ253eQQxSq)(nelua_GC_ptr);
...
typedef void (*function_4WL3dquoTDahkSoY6)(void*, void*);
static bool nelua_GC_step(nelua_GC_ptr self);
static void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_4WL3dquoTDahkSoY6 finalizer, void* userdata);
...
typedef int (*function_3vtUZpRE9ne7bmtvy)(int, nlcstring_ptr);
...
static nelua_span_uint32_ nelua_GCAllocator_spanalloc_2(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata);
static nelua_span_elf64Shdr_ nelua_GCAllocator_spanalloc_3(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata);
...
static nelua_span_usize_ nelua_GCAllocator_spanalloc_5(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata);
...
typedef int (*function_2cYjJgSNUnsPjypKt)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_2cYjJgSNUnsPjypKt closef;
};
...
static NELUA_NOINLINE nelua_sequenceimpl_uint32__ptr nelua_GCAllocator_new_3(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags);
static void nelua_assert_line_59(bool cond, nlstring msg);
static NELUA_NOINLINE nelua_sequenceimpl_elf64Shdr__ptr nelua_GCAllocator_new_4(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags);
...
static nelua_span_uint32_ nelua_GCAllocator_spanrealloc_3(nelua_GCAllocator_ptr self, nelua_span_uint32_ s, uintptr_t size);
static nelua_span_usize_ nelua_GCAllocator_spanrealloc_4(nelua_GCAllocator_ptr self, nelua_span_usize_ s, uintptr_t size);
...
static nelua_span_uint32_ nelua_GCAllocator_xspanrealloc_3(nelua_GCAllocator_ptr self, nelua_span_uint32_ s, uintptr_t size);
static nelua_span_usize_ nelua_GCAllocator_xspanrealloc_4(nelua_GCAllocator_ptr self, nelua_span_usize_ s, uintptr_t size);
...
static NELUA_INLINE uint8_t nelua_strchar_1_tolower(uint8_t c);
...
static nlstring nelua_nlstring___concat_3(nlstring a, int64_t b);
...
typedef int (*function_2amZiymw6pgrW6xn6)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_2amZiymw6pgrW6xn6 closef);
...
typedef nlmulret_nlboolean_nlstring (*function_DoRkucoJPU9mcyeq)(nelua_LinesState, nlstring);
typedef struct nlmulret_function_DoRkucoJPU9mcyeq_nelua_LinesState_nlstring {
  function_DoRkucoJPU9mcyeq r1;
  nelua_LinesState r2;
  nlstring r3;
} nlmulret_function_DoRkucoJPU9mcyeq_nelua_LinesState_nlstring;
static nlmulret_function_DoRkucoJPU9mcyeq_nelua_LinesState_nlstring nelua_filestream_lines_1(nelua_filestream_ptr self, nlniltype fmt);
...
typedef int (*function_2SCnXYr4PLqoH296G)(FILE_ptr);
...
static nelua_sequence_uint32_ main_program;
static uint64_t main_stringLen;
static NELUA_INLINE intptr_t main_getProgramSize(void);
static nlstring argHandling_fileout;
static nlstring argHandling_filein;
static nlstring argHandling_execPath;
typedef struct record_33CpPeKuDXtLUWvUV record_33CpPeKuDXtLUWvUV;
struct record_33CpPeKuDXtLUWvUV {
  bool dump;
};
NELUA_STATIC_ASSERT(sizeof(record_33CpPeKuDXtLUWvUV) == 1 && NELUA_ALIGNOF(record_33CpPeKuDXtLUWvUV) == 1, "Nelua and C disagree on type size or align");
static record_33CpPeKuDXtLUWvUV argHandling_execArgs = {0};
...
typedef struct nlmulret_nlisize_nluint32_arr3 {
  intptr_t r1;
  nluint32_arr3 r2;
} nlmulret_nlisize_nluint32_arr3;
static nlmulret_nlisize_nluint32_arr3 instr_getArgs(nlstring mnemonic, nlstring argsStr);
...
static uint32_t instr_getInstr(nlstring mnemonic, nluint32_arr3 args);
...
static nelua_sequence_uint32_ pseudo_anonfunc(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_1(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_2(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_3(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_4(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_5(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_6(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_7(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_8(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_9(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_10(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_11(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_12(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_13(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_14(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_15(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_16(nluint32_arr3 args);
static nelua_sequence_uint32_ pseudo_anonfunc_17(nluint32_arr3 args);
...
static void elf_writeToFile(nlstring filename, nelua_sequence_uint32_ program_1, uint64_t start, bool strip);
static NELUA_INLINE uint64_t nelua_assert_narrow_nlisize_nluint64(intptr_t x);
...
static nlstring main_curLabel;
static int64_t main_addressLabel;
static int64_t main_preAddressLabel;
static nelua_filestream main_file;
static FILE_ptr main_cfile;
static nlstring main_parseString(nlstring str);
static NELUA_INLINE intptr_t nelua_assert_imod_nlisize(intptr_t a, intptr_t b);
static NELUA_INLINE uint32_t nelua_shl_nluint32(uint32_t a, int32_t b);
static int64_t main_curLine = 1;
...
nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string__1 a_1, int64_t k) {
  k = (k + 1);
  if((k >= (nelua_sequence_string__1___len((&a_1)) + 1))) {
    return (nlmulret_nlboolean_nlint64_nlstring){false, 0, (nlstring){0}};
  }
  nlmulret_nlboolean_nlint64_nlstring _mulret_1;
  _mulret_1.r1 = true;
  _mulret_1.r2 = k;
  _mulret_1.r3 = (*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&a_1), nelua_assert_narrow_nlint64_nlusize(k))));
  return _mulret_1;
}
nlmulret_function_2JzBeaBv9DUsZfMnm_nelua_sequence_string__1_nlint64 nelua_ipairs_1(nelua_sequence_string__1 a) {
  return (nlmulret_function_2JzBeaBv9DUsZfMnm_nelua_sequence_string__1_nlint64){nelua_ipairs_next, a, 0};
}
nlmulret_nlboolean_nlint64_nluint8 nelua_ipairs_next_1(nlstring_ptr a_2, int64_t k) {
  k = (k + 1);
  if((k >= (nelua_nlstring___len((*(nlstring*)nelua_assert_deref(a_2))) + 1))) {
    return (nlmulret_nlboolean_nlint64_nluint8){false, 0, 0U};
  }
  return (nlmulret_nlboolean_nlint64_nluint8){true, k, (*(uint8_t*)nelua_assert_deref(nelua_nlstring___atindex((*(nlstring*)nelua_assert_deref(a_2)), nelua_assert_narrow_nlint64_nlusize(k))))};
}
nlmulret_function_2vLzwm7GgVbixrMzR_nlstring_ptr_nlint64 nelua_ipairs_2(nlstring_ptr a) {
  return (nlmulret_function_2vLzwm7GgVbixrMzR_nlstring_ptr_nlint64){nelua_ipairs_next_1, a, 0};
}
nlmulret_nlboolean_nlint64_nluint32 nelua_ipairs_next_2(nelua_sequence_uint32_ a_3, int64_t k) {
  k = (k + 1);
  if((k >= (nelua_sequence_uint32____len((&a_3)) + 1))) {
    return (nlmulret_nlboolean_nlint64_nluint32){false, 0, 0U};
  }
  nlmulret_nlboolean_nlint64_nluint32 _mulret_1;
  _mulret_1.r1 = true;
  _mulret_1.r2 = k;
  _mulret_1.r3 = (*(uint32_t*)nelua_assert_deref(nelua_sequence_uint32____atindex((&a_3), nelua_assert_narrow_nlint64_nlusize(k))));
  return _mulret_1;
}
nlmulret_function_2xeznntUSZa5dDBQC_nelua_sequence_uint32__nlint64 nelua_ipairs_3(nelua_sequence_uint32_ a) {
  return (nlmulret_function_2xeznntUSZa5dDBQC_nelua_sequence_uint32__nlint64){nelua_ipairs_next_2, a, 0};
}
nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer nelua_pairs_1(nelua_hashmap_pointer__usize__ptr a) {
  nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer _ret_1 = nelua_hashmap_pointer__usize____pairs(a);
  return (nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring nelua_pairs_2(nelua_hashmap_string__uint32__ptr a) {
  nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring _ret_1 = nelua_hashmap_string__uint32____pairs(a);
  return (nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer nelua_mpairs_1(nelua_hashmap_pointer__GCItem__ptr a) {
  nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer _ret_1 = nelua_hashmap_pointer__GCItem____mpairs(a);
  return (nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer){_ret_1.r1, _ret_1.r2, _ret_1.r3};
}
nelua_sequence_string_ nelua_select_1(nlniltype index, bool __arg1, nelua_sequence_string_ __arg2) {
  return __arg2;
}
...
void nelua_sequenceT_grow(nelua_sequence_string__ptr self) {
  ...
  if(NELUA_LIKELY((curcap != 0))) {
    cap = (curcap * 2);
    nelua_assert_line_20((cap > curcap), ((nlstring){(uint8_t*)"capacity overflow", 17}));
  }
  self->impl->data = nelua_GCAllocator_xspanrealloc_2((&self->allocator), self->impl->data, cap);
  if(NELUA_UNLIKELY((curcap == 0))) {
    (*(nlstring*)nelua_assert_deref(nelua_span_string____atindex(self->impl->data, 0U))) = (nlstring){0};
...
nlstring_ptr nelua_sequence_string____atindex(nelua_sequence_string__ptr self, uintptr_t pos) {
  ...
  if(NELUA_UNLIKELY((pos > self->impl->size))) {
    nelua_assert_line_21((pos == (self->impl->size + 1)), ((nlstring){(uint8_t*)"position out of bounds", 22}));
...
void nelua_sequenceT_grow_1(nelua_sequence_string__1_ptr self) {
  ...
  if(NELUA_LIKELY((curcap != 0))) {
    cap = (curcap * 2);
    nelua_assert_line_22((cap > curcap), ((nlstring){(uint8_t*)"capacity overflow", 17}));
  }
  self->impl->data = nelua_GeneralAllocator_xspanrealloc_4((&self->allocator), self->impl->data, cap);
  if(NELUA_UNLIKELY((curcap == 0))) {
    (*(nlstring*)nelua_assert_deref(nelua_span_string____atindex(self->impl->data, 0U))) = (nlstring){0};
...
nlstring_ptr nelua_sequence_string__1___atindex(nelua_sequence_string__1_ptr self, uintptr_t pos) {
  nelua_sequence_string__1__init(self);
  if(NELUA_UNLIKELY((pos > self->impl->size))) {
    nelua_assert_line_23((pos == (self->impl->size + 1)), ((nlstring){(uint8_t*)"position out of bounds", 22}));
    self->impl->size = (self->impl->size + 1);
    if(NELUA_UNLIKELY(((self->impl->size + 1) > self->impl->data.size))) {
...
void nelua_sequence_uint32___init(nelua_sequence_uint32__ptr self) {
  if(NELUA_LIKELY((self->impl != NULL))) {
    return;
  }
  self->impl = nelua_GCAllocator_new_3((&self->allocator), NELUA_NIL, NELUA_NIL, NELUA_NIL);
}
void nelua_sequence_uint32__reserve(nelua_sequence_uint32__ptr self, uintptr_t n) {
  nelua_sequence_uint32___init(self);
  uintptr_t cap = (n + 1);
  uintptr_t curcap = self->impl->data.size;
  if((curcap >= cap)) {
    return;
  }
  self->impl->data = nelua_GCAllocator_xspanrealloc_3((&self->allocator), self->impl->data, cap);
  if(NELUA_UNLIKELY((curcap == 0))) {
    (*(uint32_t*)nelua_assert_deref(nelua_span_uint32____atindex(self->impl->data, 0U))) = 0U;
  }
}
...
void nelua_sequenceT_grow_2(nelua_sequence_uint32__ptr self) {
  uintptr_t cap = 2U;
  uintptr_t curcap = self->impl->data.size;
  if(NELUA_LIKELY((curcap != 0))) {
    cap = (curcap * 2);
    nelua_assert_line_24((cap > curcap), ((nlstring){(uint8_t*)"capacity overflow", 17}));
  }
  self->impl->data = nelua_GCAllocator_xspanrealloc_3((&self->allocator), self->impl->data, cap);
  if(NELUA_UNLIKELY((curcap == 0))) {
    (*(uint32_t*)nelua_assert_deref(nelua_span_uint32____atindex(self->impl->data, 0U))) = 0U;
...
nluint32_ptr nelua_sequence_uint32____atindex(nelua_sequence_uint32__ptr self, uintptr_t pos) {
  nelua_sequence_uint32___init(self);
  if(NELUA_UNLIKELY((pos > self->impl->size))) {
    nelua_assert_line_25((pos == (self->impl->size + 1)), ((nlstring){(uint8_t*)"position out of bounds", 22}));
    self->impl->size = (self->impl->size + 1);
    if(NELUA_UNLIKELY(((self->impl->size + 1) > self->impl->data.size))) {
      nelua_sequenceT_grow_2(self);
    }
    (*(uint32_t*)nelua_assert_deref(nelua_span_uint32____atindex(self->impl->data, pos))) = 0U;
  } else if(NELUA_UNLIKELY(((self->impl->data.size == 0) && (pos == 0)))) {
    nelua_sequenceT_grow_2(self);
  }
  return (&(*(uint32_t*)nelua_assert_deref(nelua_span_uint32____atindex(self->impl->data, pos))));
}
intptr_t nelua_sequence_uint32____len(nelua_sequence_uint32__ptr self) {
  if(NELUA_UNLIKELY((!(self->impl != NULL)))) {
    return 0;
  }
  return (intptr_t)self->impl->size;
...
nelua_sequence_uint32_ nelua_sequence_uint32____convert_1(nluint32_arr1 values) {
  nelua_sequence_uint32_ self = (nelua_sequence_uint32_){0};
  nelua_sequence_uint32__reserve((&self), 1U);
  self.impl->size = 1U;
  for(uintptr_t i = 1U; i <= 1U; i += 1) {
    (*(uint32_t*)nelua_assert_deref(nelua_span_uint32____atindex(self.impl->data, i))) = values.v[nelua_assert_bounds_nlusize((i - 1), 1)];
  }
  return self;
}
nelua_sequence_uint32_ nelua_sequence_uint32____convert_2(nluint32_arr2 values) {
  nelua_sequence_uint32_ self = (nelua_sequence_uint32_){0};
  nelua_sequence_uint32__reserve((&self), 2U);
  self.impl->size = 2U;
  for(uintptr_t i = 1U; i <= 2U; i += 1) {
    (*(uint32_t*)nelua_assert_deref(nelua_span_uint32____atindex(self.impl->data, i))) = values.v[nelua_assert_bounds_nlusize((i - 1), 2)];
  }
  return self;
}
...
void nelua_sequenceT_grow_3(nelua_sequence_elf64Shdr__ptr self) {
  uintptr_t cap = 2U;
  uintptr_t curcap = self->impl->data.size;
  if(NELUA_LIKELY((curcap != 0))) {
    cap = (curcap * 2);
    nelua_assert_line_26((cap > curcap), ((nlstring){(uint8_t*)"capacity overflow", 17}));
  }
...
elf_elf64Shdr_ptr nelua_sequence_elf64Shdr____atindex(nelua_sequence_elf64Shdr__ptr self, uintptr_t pos) {
  ...
  if(NELUA_UNLIKELY((pos > self->impl->size))) {
    nelua_assert_line_27((pos == (self->impl->size + 1)), ((nlstring){(uint8_t*)"position out of bounds", 22}));
    self->impl->size = (self->impl->size + 1);
    if(NELUA_UNLIKELY(((self->impl->size + 1) > self->impl->data.size))) {
...
void nelua_assert_line_28(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
...
void nelua_hashmap_pointer__GCItem__rehash(nelua_hashmap_pointer__GCItem__ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_28((j == self->size));
  }
...
uintptr_t nelua_hashmap_pointer__GCItem___at(nelua_hashmap_pointer__GCItem__ptr self, void* key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_29((node_index_1 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer nelua_hashmap_pointer__GCItem____mpairs(nelua_hashmap_pointer__GCItem__ptr self) {
  return (nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer){nelua_hashmap_iteratorT_mnext, (nelua_hashmap_iteratorT){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
void nelua_assert_line_30(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/usr/local/lib/nelua/lib/hashmap.nelua\033[1m:214:15: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n      check(j == self.size)\n              \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~\033[0m\n",  182, true);
    nelua_abort();
  }
...
void nelua_hashmap_pointer__usize__rehash(nelua_hashmap_pointer__usize__ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_30((j == self->size));
  }
...
uintptr_t nelua_hashmap_pointer__usize___at(nelua_hashmap_pointer__usize__ptr self, void* key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_31((node_index_2 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer nelua_hashmap_pointer__usize____pairs(nelua_hashmap_pointer__usize__ptr self) {
  return (nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer){nelua_hashmap_iteratorT_1_next, (nelua_hashmap_iteratorT_1){.container = self, .index = 0xffffffffffffffffULL}, NULL};
}
...
void nelua_assert_line_32(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/usr/local/lib/nelua/lib/hashmap.nelua\033[1m:214:15: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n      check(j == self.size)\n              \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~\033[0m\n",  182, true);
    nelua_abort();
  }
...
void nelua_hashmap_uint8__V__rehash(nelua_hashmap_uint8__V__ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_32((j == self->size));
  }
  self->nodes = nelua_GCAllocator_xspanrealloc0_1((&self->allocator), self->nodes, node_count);
  self->buckets = nelua_GCAllocator_xspanrealloc_4((&self->allocator), self->buckets, bucket_count);
  nelua_memory_spanset_1(self->buckets, 0xffffffffffffffffULL);
  uintptr_t free_index = 0xffffffffffffffffULL;
  for(intptr_t i = (intptr_t)(self->nodes.size - 1); i >= 0; i += -1) {
...
uintptr_t nelua_hashmap_uint8__V___at(nelua_hashmap_uint8__V__ptr self, uint8_t key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_33((node_index_3 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
void nelua_assert_line_34(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/usr/local/lib/nelua/lib/hashmap.nelua\033[1m:214:15: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n      check(j == self.size)\n              \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~\033[0m\n",  182, true);
    nelua_abort();
  }
...
void nelua_hashmap_string__V__rehash(nelua_hashmap_string__V__ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_34((j == self->size));
  }
...
uintptr_t nelua_hashmap_string__V___at(nelua_hashmap_string__V__ptr self, nlstring key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_35((node_index_4 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
void nelua_assert_line_36(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/usr/local/lib/nelua/lib/hashmap.nelua\033[1m:214:15: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n      check(j == self.size)\n              \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~\033[0m\n",  182, true);
    nelua_abort();
  }
...
void nelua_hashmap_string__V__1_rehash(nelua_hashmap_string__V__1_ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_36((j == self->size));
  }
...
uintptr_t nelua_hashmap_string__V__1__at(nelua_hashmap_string__V__1_ptr self, nlstring key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_37((node_index_5 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
void nelua_assert_line_38(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/usr/local/lib/nelua/lib/hashmap.nelua\033[1m:214:15: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n      check(j == self.size)\n              \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~\033[0m\n",  182, true);
    nelua_abort();
  }
...
void nelua_hashmap_string__V__2_rehash(nelua_hashmap_string__V__2_ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_38((j == self->size));
  }
...
uintptr_t nelua_hashmap_string__V__2__at(nelua_hashmap_string__V__2_ptr self, nlstring key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_39((node_index_6 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
void nelua_assert_line_40(bool cond) {
  if(NELUA_UNLIKELY(!cond)) {
    nelua_write_stderr("/usr/local/lib/nelua/lib/hashmap.nelua\033[1m:214:15: \033[31m\033[1mruntime error: \033[0m\033[1massertion failed!\033[0m\n      check(j == self.size)\n              \033[1m\033[32m^\033[0m\033[35m~~~~~~~~~~~\033[0m\n",  182, true);
    nelua_abort();
  }
...
void nelua_hashmap_string__uint32__rehash(nelua_hashmap_string__uint32__ptr self, uintptr_t bucket_count) {
  ...
  if((((node_count < self->nodes.size) && (self->nodes.size > 0)) && (node_count > 0))) {
    ...
    nelua_assert_line_40((j == self->size));
  }
...
uintptr_t nelua_hashmap_string__uint32___at(nelua_hashmap_string__uint32__ptr self, nlstring key) {
  ...
  if((node_index != 0xffffffffffffffffULL)) {
    ...
    nelua_assert_line_41((node_index_7 < self->nodes.size), ((nlstring){(uint8_t*)"not enough space to add a node", 30}));
...
nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring nelua_hashmap_string__uint32____pairs(nelua_hashmap_string__uint32__ptr self) {
  return (nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring){nelua_hashmap_iteratorT_6_next, (nelua_hashmap_iteratorT_6){.container = self, .index = 0xffffffffffffffffULL}, (nlstring){0}};
}
...
nelua_GCScanRange nelua_vector_GCScanRange__pop(nelua_vector_GCScanRange__ptr self) {
  nelua_assert_line_45((self->size > 0), ((nlstring){(uint8_t*)"attempt to pop an empty vector", 30}));
  self->size = (self->size - 1);
...
void nelua_GC_unregister_1(nelua_GC_ptr self, void* ptr, bool finalize) {
  ...
  if(NELUA_LIKELY((item.size != 0))) {
    ...
    nelua_assert_line_46((oldsize != 0), ((nlstring){(uint8_t*)"invalid unregister pointer", 26}));
  }
}
...
void nelua_GC_mark(nelua_GC_ptr self) {
  {
    nlmulret_function_45P6aQnHsd7fUeWma_nelua_hashmap_iteratorT_1_nlpointer _asgnret_1 = nelua_pairs_1((&self->rootitems));
    function_45P6aQnHsd7fUeWma __fornext = _asgnret_1.r1;
  ...
  if((self->stackbottom != 0)) {
    volatile function_RGDckgJ253eQQxSq scanstack = nelua_GC_scanstack;
    scanstack(self);
  }
...
void nelua_GC_sweep(nelua_GC_ptr self) {
  ...
  {
    nlmulret_function_4nXR3uaisqxAY6BF8_nelua_hashmap_iteratorT_nlpointer _asgnret_1 = nelua_mpairs_1((&self->items));
    function_4nXR3uaisqxAY6BF8 __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = ptr;
      {
        ...
        if(nelua_hasflag(item_flags, 65536U)) {
          ...
          nelua_assert_line_47(removed, ((nlstring){(uint8_t*)"gc item not found to erase", 26}));
  ...
  while((i < self->finalizeitems.size)) {
    ...
    if(NELUA_LIKELY((ptr != NULL))) {
      nelua_GCItem_ptr item = nelua_hashmap_pointer__GCItem__peek((&self->items), ptr);
      nelua_assert_line_48((item != ((nelua_GCItem_ptr)NULL)), ((nlstring){(uint8_t*)"gc item not found to finalize", 29}));
  ...
  while((i_1 < self->finalizeitems.size)) {
    ...
    if(NELUA_LIKELY((ptr != NULL))) {
      nelua_GCItem item = nelua_hashmap_pointer__GCItem__remove((&self->items), ptr);
      nelua_assert_line_49((item.size != 0), ((nlstring){(uint8_t*)"gc item not found to deallocate", 31}));
      if(NELUA_LIKELY((item.size != 0))) {
        self->membytes = (self->membytes - item.size);
...
void nelua_GC_registerroots(nelua_GC_ptr self) {
  nelua_GC_register((&nelua_gc), (void*)(&nelua_arg), 8U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_program), 8U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&argHandling_fileout), 16U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&argHandling_filein), 16U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&argHandling_execPath), 16U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&label_labels), 48U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&instr_instruction), 48U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&pseudo_pseudoInstr), 48U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_curLabel), 16U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_file), 8U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&main_cfile), 8U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&argHandling_opt), 48U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&elf_shdrs), 8U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
  nelua_GC_register((&nelua_gc), (void*)(&elf_names), 48U, 131072U, (function_4WL3dquoTDahkSoY6)NULL, (void*)NULL);
}
...
void nelua_GC_register(nelua_GC_ptr self, void* ptr, uintptr_t size, uintptr_t flags, function_4WL3dquoTDahkSoY6 finalizer, void* userdata) {
  if(NELUA_UNLIKELY((!(ptr != NULL)))) {
    return;
  }
  nelua_assert_line_50((size > 0), ((nlstring){(uint8_t*)"attempt to register a pointer with size zero", 44}));
  if(NELUA_LIKELY((!nelua_hasflag(flags, 131072U)))) {
    ...
    nelua_assert_line_51((item->size == 0), ((nlstring){(uint8_t*)"cannot register pointer twice", 29}));
    ...
    nelua_assert_line_52((flags == 131072U), ((nlstring){(uint8_t*)"attempt to register a root pointer with invalid flags", 53}));
    nelua_assert_line_53(((finalizer == (function_4WL3dquoTDahkSoY6)NULL) && (userdata == (void*)NULL)), ((nlstring){(uint8_t*)"attempt to register a root pointer with finalizer", 49}));
...
void nelua_GC_reregister(nelua_GC_ptr self, void* oldptr, void* newptr, uintptr_t newsize) {
  nelua_assert_line_54((((oldptr != (void*)NULL) && (newptr != (void*)NULL)) && (newsize > 0)), ((nlstring){(uint8_t*)"invalid reregister arguments", 28}));
  if((newptr == oldptr)) {
    ...
    if(NELUA_LIKELY((item != NULL))) {
      ...
      nelua_assert_line_55((oldsize != 0), ((nlstring){(uint8_t*)"invalid reregister pointer", 26}));
    ...
    if(NELUA_LIKELY((item.size != 0))) {
      ...
      uintptr_t oldsize = nelua_hashmap_pointer__usize__remove((&self->rootitems), oldptr);
      nelua_assert_line_56((oldsize != 0), ((nlstring){(uint8_t*)"invalid reregister pointer", 26}));
      (*(uintptr_t*)nelua_assert_deref(nelua_hashmap_pointer__usize____atindex((&self->rootitems), newptr))) = newsize;
    }
  }
}
...
int main(int argc, nlcstring_ptr argv) {
  ...
  volatile function_3vtUZpRE9ne7bmtvy inner_main = nelua_main;
...
nelua_span_uint32_ nelua_GCAllocator_spanalloc_2(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  uintptr_t flags_6 = 262144U;
  nelua_GCFinalizerCallback finalizer_3 = (nelua_GCFinalizerCallback)NULL;
  void* userdata_3 = (void*)NULL;
  if(NELUA_LIKELY((size > 0))) {
    nluint32_arr0_ptr data = ((nluint32_arr0_ptr)nelua_GCAllocator_alloc_3(self, (size * 4), flags_6, finalizer_3, userdata_3));
...
nelua_span_elf64Shdr_ nelua_GCAllocator_spanalloc_3(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  uintptr_t flags_7 = 262144U;
  nelua_GCFinalizerCallback finalizer_4 = (nelua_GCFinalizerCallback)NULL;
  void* userdata_4 = (void*)NULL;
  if(NELUA_LIKELY((size > 0))) {
    elf_elf64Shdr_arr0_ptr data = ((elf_elf64Shdr_arr0_ptr)nelua_GCAllocator_alloc_3(self, (size * 64), flags_7, finalizer_4, userdata_4));
...
nelua_span_uint8_ nelua_GCAllocator_spanalloc_4(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    nluint8_arr0_ptr data = ((nluint8_arr0_ptr)nelua_GCAllocator_alloc_3(self, (size * 1), flags_8, finalizer_5, userdata_5));
...
nelua_span_usize_ nelua_GCAllocator_spanalloc_5(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  uintptr_t flags_9 = 262144U;
  nelua_GCFinalizerCallback finalizer_6 = (nelua_GCFinalizerCallback)NULL;
  void* userdata_6 = (void*)NULL;
  if(NELUA_LIKELY((size > 0))) {
    nlusize_arr0_ptr data = ((nlusize_arr0_ptr)nelua_GCAllocator_alloc_3(self, (size * 8), flags_9, finalizer_6, userdata_6));
    if(NELUA_LIKELY((data != ((nlusize_arr0_ptr)NULL)))) {
      return (nelua_span_usize_){.data = data, .size = size};
    }
  }
...
nelua_span_uint8_ nelua_GCAllocator_spanalloc0_1(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    nluint8_arr0_ptr data = ((nluint8_arr0_ptr)nelua_GCAllocator_alloc0_2(self, (size * 1), flags_10, finalizer_7, userdata_7));
    if(NELUA_LIKELY((data != ((nluint8_arr0_ptr)NULL)))) {
      return (nelua_span_uint8_){.data = data, .size = size};
    }
  }
...
nelua_span_hashmapnode_uint8__V__ nelua_GCAllocator_spanalloc0_2(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    nelua_hashmapnode_uint8__V__arr0_ptr data = ((nelua_hashmapnode_uint8__V__arr0_ptr)nelua_GCAllocator_alloc0_1(self, (size * 48), NELUA_NIL, finalizer_8, userdata_8));
...
nelua_span_hashmapnode_string__V__ nelua_GCAllocator_spanalloc0_3(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    nelua_hashmapnode_string__V__arr0_ptr data = ((nelua_hashmapnode_string__V__arr0_ptr)nelua_GCAllocator_alloc0_1(self, (size * 48), NELUA_NIL, finalizer_9, userdata_9));
...
nelua_span_hashmapnode_string__V___1 nelua_GCAllocator_spanalloc0_4(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    nelua_hashmapnode_string__V__1_arr0_ptr data = ((nelua_hashmapnode_string__V__1_arr0_ptr)nelua_GCAllocator_alloc0_1(self, (size * 48), NELUA_NIL, finalizer_10, userdata_10));
...
nelua_span_hashmapnode_string__V___2 nelua_GCAllocator_spanalloc0_5(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    nelua_hashmapnode_string__V__2_arr0_ptr data = ((nelua_hashmapnode_string__V__2_arr0_ptr)nelua_GCAllocator_alloc0_1(self, (size * 48), NELUA_NIL, finalizer_11, userdata_11));
...
nelua_span_hashmapnode_string__uint32__ nelua_GCAllocator_spanalloc0_6(nelua_GCAllocator_ptr self, nlniltype T, uintptr_t size, nlniltype flags, nlniltype finalizer, nlniltype userdata) {
  ...
  if(NELUA_LIKELY((size > 0))) {
    nelua_hashmapnode_string__uint32__arr0_ptr data = ((nelua_hashmapnode_string__uint32__arr0_ptr)nelua_GCAllocator_alloc0_1(self, (size * 32), NELUA_NIL, finalizer_12, userdata_12));
...
nelua_sequenceimpl_string__ptr nelua_GCAllocator_new_1(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_57((ptr != ((nelua_sequenceimpl_string__ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
nelua_FStream_ptr nelua_GCAllocator_new_2(nelua_GCAllocator_ptr self, nelua_FStream what, nlniltype size, nlniltype flags) {
  ...
  nelua_assert_line_58((ptr != ((nelua_FStream_ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
...
nelua_sequenceimpl_uint32__ptr nelua_GCAllocator_new_3(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  nelua_GCFinalizerCallback finalizer = (nelua_GCFinalizerCallback)NULL;
  nelua_sequenceimpl_uint32__ptr ptr;
  ptr = ((nelua_sequenceimpl_uint32__ptr)nelua_GCAllocator_alloc0_1((&nelua_gc_allocator), 24U, NELUA_NIL, finalizer, (void*)NULL));
  nelua_assert_line_59((ptr != ((nelua_sequenceimpl_uint32__ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
nelua_sequenceimpl_elf64Shdr__ptr nelua_GCAllocator_new_4(nelua_GCAllocator_ptr self, nlniltype what, nlniltype size, nlniltype flags) {
  nelua_GCFinalizerCallback finalizer = (nelua_GCFinalizerCallback)NULL;
  ...
  nelua_assert_line_60((ptr != ((nelua_sequenceimpl_elf64Shdr__ptr)NULL)), ((nlstring){(uint8_t*)"out of memory", 13}));
  return ptr;
}
...
nelua_span_uint32_ nelua_GCAllocator_spanrealloc_3(nelua_GCAllocator_ptr self, nelua_span_uint32_ s, uintptr_t size) {
  if(NELUA_UNLIKELY(((s.size == 0) && (size > 0)))) {
...
nelua_span_usize_ nelua_GCAllocator_spanrealloc_4(nelua_GCAllocator_ptr self, nelua_span_usize_ s, uintptr_t size) {
  if(NELUA_UNLIKELY(((s.size == 0) && (size > 0)))) {
...
nelua_span_uint32_ nelua_GCAllocator_xspanrealloc_3(nelua_GCAllocator_ptr self, nelua_span_uint32_ s, uintptr_t size) {
...
nelua_span_usize_ nelua_GCAllocator_xspanrealloc_4(nelua_GCAllocator_ptr self, nelua_span_usize_ s, uintptr_t size) {
...
nelua_span_hashmapnode_uint8__V__ nelua_GCAllocator_spanrealloc0_2(nelua_GCAllocator_ptr self, nelua_span_hashmapnode_uint8__V__ s, uintptr_t size) {
  ...
  nelua_hashmapnode_uint8__V__arr0_ptr p = ((nelua_hashmapnode_uint8__V__arr0_ptr)nelua_GCAllocator_realloc0(self, (void*)s.data, (size * 48), (s.size * 48)));
...
uint8_t nelua_strchar_1_tolower(uint8_t c) {
  return ((((uint32_t)c - 65U) < 26) ? (c | 32) : c);
}
...
void nelua_stringbuilderT_commit(nelua_stringbuilderT_ptr self, uintptr_t n) {
  ...
  nelua_assert_line_61((newsize <= self->data.size), ((nlstring){(uint8_t*)"not enough space in string buffer", 33}));
  self->size = newsize;
}
...
nlstring nelua_nlstring_create(uintptr_t size) {
  nelua_assert_line_62((size > 0), ((nlstring){(uint8_t*)"attempt to create an empty string", 33}));
...
uint8_t nelua_nlstring_byte_1(nlstring s, nlniltype i) {
  ...
  nelua_assert_line_63(((i_2 >= 1) && ((uintptr_t)i_2 <= s.size)), ((nlstring){(uint8_t*)"index out of range", 18}));
  return s.data[(i_2 - 1)];
}
...
nlstring nelua_nlstring_lower(nlstring s) {
  ...
  for(uintptr_t i = 0U, _end = s.size; i < _end; i += 1) {
    ret.data[i] = nelua_strchar_1_tolower(s.data[i]);
  }
  return ret;
}
...
nluint8_ptr nelua_nlstring___atindex(nlstring s, uintptr_t i) {
  nelua_assert_line_64(((i >= 1) && (i <= s.size)), ((nlstring){(uint8_t*)"index out of range", 18}));
  return (&s.data[(i - 1)]);
}
...
nlstring nelua_nlstring___concat_3(nlstring a, int64_t b) {
...
intptr_t nelua_match_class_end(nelua_StrPatt_1_ptr ms_1, intptr_t p_1) {
  ...
  switch(c) {
    case 37U: {
      nelua_assert_line_65((p_1 != nelua_nlstring___len(ms_1->pattern)), ((nlstring){(uint8_t*)"malformed pattern (ends with '%')", 33}));
      p_1 = (p_1 + 1);
      break;
    }
    case 91U: {
      ...
      }
      {
        bool _repeat_stop;
        do {
          nelua_assert_line_66((p_1 != nelua_nlstring___len(ms_1->pattern)), ((nlstring){(uint8_t*)"malformed pattern (missing ']')", 31}));
...
intptr_t nelua_match_balance(nelua_StrPatt_1_ptr ms_4, intptr_t s_2, intptr_t p_4) {
  nelua_assert_line_67((p_4 < (nelua_nlstring___len(ms_4->pattern) - 1)), ((nlstring){(uint8_t*)"malformed pattern (missing arguments to '%b')", 45}));
...
intptr_t nelua_match_start_capture(nelua_StrPatt_1_ptr ms_7, intptr_t s_5, intptr_t p_7, intptr_t what) {
  ...
  nelua_assert_line_68((numcaptures < 32), ((nlstring){(uint8_t*)"too many captures", 17}));
...
intptr_t nelua_match_end_capture(nelua_StrPatt_1_ptr ms_8, intptr_t s_6, intptr_t p_8) {
  ...
  nelua_assert_line_69((l != -1), ((nlstring){(uint8_t*)"invalid pattern capture", 23}));
...
intptr_t nelua_match_capture(nelua_StrPatt_1_ptr ms_9, intptr_t s_7, intptr_t l) {
  l = (intptr_t)(l - 49U);
  nelua_assert_line_70((((l >= 0) && (l < ms_9->numcaptures)) && (ms_9->capture[nelua_assert_bounds_nlisize(l, 32)].len != -1)), ((nlstring){(uint8_t*)"invalid capture index", 21}));
...
intptr_t nelua_StrPatt_1__match(nelua_StrPatt_1_ptr ms, intptr_t s, intptr_t p) {
  ms->depth = (ms->depth - 1);
  nelua_assert_line_71((ms->depth > 0), ((nlstring){(uint8_t*)"pattern too complex", 19}));
    ...
    switch(ms->pattern.data[p]) {
      ...
      case 37U: {
        switch(ms->pattern.data[(p + 1)]) {
          ...
          case 102U: {
            p = (p + 2);
            nelua_assert_line_72((ms->pattern.data[p] == 91U), ((nlstring){(uint8_t*)"missing '[' after '%f' in pattern", 33}));
  ...
  if((endpos != -1)) {
    if((ms.numcaptures > 0)) {
      ...
      for(intptr_t i = 0, _end = ms.numcaptures; i < _end; i += 1) {
        ...
        nelua_assert_line_73(ok, capstr);
        nelua_assert_line_74((!nelua_StrPattCapture_is_position((&capture))), ((nlstring){(uint8_t*)"position capture not supported yet", 34}));
...
int64_t nelua_tointeger_1(nlstring x, nlniltype base) {
  ...
  nelua_assert_line_75(ok, ((nlstring){(uint8_t*)"malformed integer", 17}));
  return i;
}
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_2amZiymw6pgrW6xn6 closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_2cYjJgSNUnsPjypKt)NULL;
  if((res != 0)) {
    nlmulret_nlstring_nlint64 _ret_1 = nelua_geterrno();
...
void nelua_error_line_1(nlstring msg) {
  nelua_write_stderr("/usr/local/lib/nelua/lib/filestream.nelua\033[1m:356:13: \033[31m\033[1mruntime error: \033[0m\033[1m", 86, false);
  nelua_write_stderr((const char*)msg.data, msg.size, false);
...
nlmulret_nlstring_nlstring_nlint64 nelua_filestream_read_1(nelua_filestream_ptr self, nlstring fmt) {
  ...
  if((c == 108U)) {
    ...
    nelua_error_line_1(((nlstring){(uint8_t*)"invalid format", 14}));
  }
  int64_t status = 0;
  if((ferror(fp) != 0)) {
    success = false;
...
nlmulret_function_DoRkucoJPU9mcyeq_nelua_LinesState_nlstring nelua_filestream_lines_1(nelua_filestream_ptr self, nlniltype fmt) {
  nlstring fmt_1 = ((nlstring){(uint8_t*)"l", 1});
  return (nlmulret_function_DoRkucoJPU9mcyeq_nelua_LinesState_nlstring){nelua_lines_next, (nelua_LinesState){.file = (*(nelua_filestream*)nelua_assert_deref(self)), .fmt = fmt_1}, (nlstring){0}};
}
...
nlmulret_nelua_filestream_nlstring_nlint64 nelua_io_popen_1(nlstring prog, nlniltype mode) {
  ...
  FILE_ptr fp = NULL;
  function_2SCnXYr4PLqoH296G closef = NULL;
#if defined(_WIN32)
...
intptr_t main_getProgramSize(void) {
  return (nelua_sequence_uint32____len((&main_program)) * 4);
}
...
void argHandling_handleOpt(uint8_t char_, uint64_t i) {
  switch((*(nelua_V_2*)nelua_assert_deref(nelua_hashmap_uint8__V____atindex((&argHandling_opt), char_))).type) {
    case 0: {
      (*(bool*)nelua_assert_deref((nlboolean_ptr)(*(nelua_V_2*)nelua_assert_deref(nelua_hashmap_uint8__V____atindex((&argHandling_opt), char_))).execArgsP)) = true;
      break;
    }
    case 1: {
      if(nelua_eq_nlisize_nluint64(nelua_sequence_string__1___len((&nelua_arg)), i)) {
        ...
        nelua_print_1(nelua_nlstring___concat_1(((nlstring){(uint8_t*)"rasm usage: ", 12}), nelua_nlstring___concat_1((*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), 0U))), ((nlstring){(uint8_t*)" [d]o a.out filein.asm", 22}))));
        nelua_os_exit_1(2);
      } else {
...
void nelua_require_argHandling(nlniltype modname) {
  ...
  (*(nelua_V_2*)nelua_assert_deref(nelua_hashmap_uint8__V____atindex((&argHandling_opt), nelua_nlstring_byte_1(((nlstring){(uint8_t*)"d", 1}), NELUA_NIL)))) = (nelua_V_2){0, 0U, (void*)(&argHandling_execArgs.dump)};
  (*(nelua_V_2*)nelua_assert_deref(nelua_hashmap_uint8__V____atindex((&argHandling_opt), nelua_nlstring_byte_1(((nlstring){(uint8_t*)"o", 1}), NELUA_NIL)))) = (nelua_V_2){1, 0U, (void*)0};
  {
    nlmulret_function_2JzBeaBv9DUsZfMnm_nelua_sequence_string__1_nlint64 _asgnret_1 = nelua_ipairs_1(nelua_arg);
    function_2JzBeaBv9DUsZfMnm __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = i;
      {
        ...
        if((i == nelua_sequence_string__1___len((&nelua_arg)))) {
          argHandling_filein = a;
          break;
        }
        {
          nlmulret_function_2vLzwm7GgVbixrMzR_nlstring_ptr_nlint64 _asgnret_3 = nelua_ipairs_2((&(*(nlstring*)nelua_assert_deref(nelua_sequence_string__1___atindex((&nelua_arg), nelua_assert_narrow_nlint64_nlusize(i))))));
          function_2vLzwm7GgVbixrMzR __fornext_1 = _asgnret_3.r1;
            ...
            __fornextit_1 = _;
            {
              if((!nelua_hashmap_uint8__V__has((&argHandling_opt), v))) {
                nelua_print_1(nelua_nlstring___concat_1(((nlstring){(uint8_t*)"Error: \"", 8}), ({
                  nlstring _tmp1 = nelua_nlstring_char_1(v);
...
nlmulret_nlisize_nluint32_arr3 instr_getArgs(nlstring mnemonic, nlstring argsStr) {
  intptr_t size = 0;
  nluint32_arr3 args = (nluint32_arr3){0};
  if(nelua_hashmap_string__V__1_has((&instr_instruction), mnemonic)) {
    switch((*(nelua_V_4*)nelua_assert_deref(nelua_hashmap_string__V__1___atindex((&instr_instruction), mnemonic))).type) {
      case 0: {
        size = 0;
        break;
      }
  ...
  nlmulret_nlboolean_nelua_sequence_string_ _asgnret_1 = nelua_nlstring_match_1(argsStr, ((nlstring){(uint8_t*)"%s*([-%%_%w%d]*)[,%s]*([-%%_%w%d]*)[,%s]*([-%%_%w%d]*)", 54}), NELUA_NIL);
  nelua_sequence_string_ a = _asgnret_1.r2;
  for(int64_t i = 0; i < 3; i += 1) {
    nlstring str = (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&a), nelua_assert_narrow_nlint64_nlusize((i + 1)))));
    if(nelua_nlstring___eq(str, ((nlstring){(uint8_t*)"", 0}))) {
      break;
    }
    if(nelua_nlstring_match_1(str, ((nlstring){(uint8_t*)"^-?%d*$", 7}), NELUA_NIL).r1) {
      args.v[nelua_assert_bounds_nlint64(i, 3)] = (uint32_t)nelua_tointeger_1(str, NELUA_NIL);
      ...
      if(((*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), str))).length == -1)) {
        args.v[nelua_assert_bounds_nlint64(i, 3)] = nelua_assert_narrow_nluint64_nluint32((*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), str))).value);
      } else {
        args.v[nelua_assert_bounds_nlint64(i, 3)] = (uint32_t)(int64_t)((*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), str))).value - main_getProgramSize());
      }
      ...
      if(nelua_hashmap_string__V__has((&label_labels), label)) {
        args.v[nelua_assert_bounds_nlint64(i, 3)] = (uint32_t)(*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), label))).length;
      }
    }
  }
  return (nlmulret_nlisize_nluint32_arr3){size, args};
}
uint32_t instr_getInstr(nlstring mnemonic, nluint32_arr3 args) {
  if((!nelua_hashmap_string__V__1_has((&instr_instruction), mnemonic))) {
  ...
  switch(curInstr.type) {
    case 0: {
      instr = (instr | ((uint32_t)curInstr.func7 << 20));
      break;
    }
    case 2: {
      NELUA_FALLTHROUGH(); /* fallthrough */
    ...
    case 1: {
      instr = (instr | (args.v[0] << 7));
      instr = (instr | (args.v[1] << 15));
      instr = (instr | (args.v[2] << 20));
      instr = (instr | ((uint32_t)curInstr.func3 << 12));
      instr = (instr | ((uint32_t)curInstr.func7 << 25));
      break;
    }
    case 3: {
      instr = (instr | (args.v[0] << 15));
      instr = (instr | (args.v[1] << 20));
      instr = (instr | ((args.v[2] & 0x1f) << 7));
      instr = (instr | ((args.v[2] >> 5) << 25));
      instr = (instr | ((uint32_t)curInstr.func3 << 12));
      break;
    }
    case 4: {
      instr = (instr | (args.v[0] << 15));
      instr = (instr | (args.v[1] << 20));
      instr = (instr | ((args.v[2] & 0x1e) << 7));
      instr = (instr | ((args.v[2] & 0x7e0) << 20));
      instr = (instr | ((args.v[2] & 0x800) >> 4));
      instr = (instr | ((args.v[2] & 0x1000) << 19));
      instr = (instr | ((uint32_t)curInstr.func3 << 12));
      break;
    }
    case 5: {
      instr = (instr | (args.v[0] << 7));
      instr = (instr | (args.v[1] << 12));
      break;
    }
    case 6: {
      instr = (instr | (args.v[0] << 7));
      instr = (instr | ((args.v[1] & 0x7fe) << 20));
      instr = (instr | (((args.v[1] >> 11) & 1) << 20));
      instr = (instr | (((args.v[1] >> 12) & 0xff) << 12));
      instr = (instr | ((args.v[1] >> 20) << 31));
      break;
    }
  }
  return instr;
...
nelua_sequence_uint32_ pseudo_anonfunc(nluint32_arr3 args) {
  nelua_sequence_uint32_ ret = (nelua_sequence_uint32_){0};
  if((args.v[1] <= 0xfff)) {
    ret = nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"addi", 4}), (nluint32_arr3){{args.v[0], 0U, args.v[1]}})}});
  } else {
    ret = nelua_sequence_uint32____convert_2(({
      nluint32_arr2 _tmp = {0};
      _tmp.v[0] = instr_getInstr(((nlstring){(uint8_t*)"lui", 3}), (nluint32_arr3){{args.v[0], (args.v[1] >> 12)}});
      _tmp.v[1] = instr_getInstr(((nlstring){(uint8_t*)"addiw", 5}), (nluint32_arr3){{args.v[0], args.v[0], args.v[1]}});
      _tmp;
    }));
  }
  return ret;
}
nelua_sequence_uint32_ pseudo_anonfunc_1(nluint32_arr3 args) {
  uint32_t val = 0U;
  if(((int32_t)args.v[1] < 0)) {
    val = ((~args.v[1]) >> 12);
  } else {
    val = (args.v[1] >> 12);
  }
  return nelua_sequence_uint32____convert_2(({
    nluint32_arr2 _tmp = {0};
    _tmp.v[0] = instr_getInstr(((nlstring){(uint8_t*)"auipc", 5}), (nluint32_arr3){{args.v[0], val}});
    _tmp.v[1] = instr_getInstr(((nlstring){(uint8_t*)"addi", 4}), (nluint32_arr3){{args.v[0], args.v[0], args.v[1]}});
    _tmp;
  }));
}
nelua_sequence_uint32_ pseudo_anonfunc_2(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"addi", 4}), (nluint32_arr3){{args.v[0], args.v[1], 0U}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_3(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"xori", 4}), (nluint32_arr3){{args.v[0], args.v[1], 0xfffU}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_4(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"sub", 3}), (nluint32_arr3){{args.v[0], 0U, args.v[1]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_5(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"blt", 3}), (nluint32_arr3){{args.v[1], args.v[0], args.v[2]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_6(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"bge", 3}), (nluint32_arr3){{args.v[1], args.v[0], args.v[2]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_7(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"bltu", 4}), (nluint32_arr3){{args.v[1], args.v[0], args.v[2]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_8(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"bgeu", 4}), (nluint32_arr3){{args.v[1], args.v[0], args.v[2]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_9(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"beq", 3}), (nluint32_arr3){{args.v[0], 0U, args.v[1]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_10(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"bne", 3}), (nluint32_arr3){{args.v[0], 0U, args.v[1]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_11(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"bge", 3}), (nluint32_arr3){{args.v[0], 0U, args.v[1]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_12(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"bge", 3}), (nluint32_arr3){{0U, args.v[0], args.v[1]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_13(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"blt", 3}), (nluint32_arr3){{0U, args.v[0], args.v[1]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_14(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"jal", 3}), (nluint32_arr3){{0U, args.v[0]}})}});
}
nelua_sequence_uint32_ pseudo_anonfunc_15(nluint32_arr3 args) {
  nelua_sequence_uint32_ ret = (nelua_sequence_uint32_){0};
  if((args.v[1] <= 0xfff)) {
    ret = nelua_sequence_uint32____convert_1((nluint32_arr1){{instr_getInstr(((nlstring){(uint8_t*)"jalr", 4}), (nluint32_arr3){{1U, 1U, args.v[0]}})}});
  } else {
    ret = nelua_sequence_uint32____convert_2(({
      nluint32_arr2 _tmp = {0};
      _tmp.v[0] = instr_getInstr(((nlstring){(uint8_t*)"lui", 3}), (nluint32_arr3){{1U, (args.v[0] >> 12)}});
      _tmp.v[1] = instr_getInstr(((nlstring){(uint8_t*)"jalr", 4}), (nluint32_arr3){{1U, 1U, args.v[0]}});
      _tmp;
    }));
  }
  return ret;
}
nelua_sequence_uint32_ pseudo_anonfunc_16(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{0x8067U}});
}
nelua_sequence_uint32_ pseudo_anonfunc_17(nluint32_arr3 args) {
  return nelua_sequence_uint32____convert_1((nluint32_arr1){{0x13U}});
}
...
void elf_addShdr(nlstring name, uint64_t sType, uint32_t flag, uint64_t size, uint64_t offset) {
  ...
  uint32_t nameN = 0U;
  nameN = elf_addString(name);
  elf_elf64Shdr shdr = (elf_elf64Shdr){nameN, (uint32_t)sType, (uint64_t)flag, offset, offset, size, 0U, 0U, (uint64_t)a, 0U};
...
uint64_t nelua_assert_narrow_nlisize_nluint64(intptr_t x) {
  if(NELUA_UNLIKELY(x < 0)) {
    nelua_panic_cstring("narrow casting from isize to uint64 failed");
  }
  return (uint64_t)x;
}
...
void elf_writeToFile(nlstring filename, nelua_sequence_uint32_ program_1, uint64_t start, bool strip) {
  elf_addShdr(((nlstring){(uint8_t*)".text", 5}), 1U, 7U, nelua_assert_narrow_nlisize_nluint64(main_getProgramSize()), ((elf_addressOffset + 64) + 128));
  if((!strip)) {
    elf_addShdr(((nlstring){(uint8_t*)".shstrtab", 9}), 3U, 0U, 0U, nelua_assert_narrow_nlisize_nluint64(((192 + main_getProgramSize()) + 56)));
  }
  elf_elf64Phdr ph = (elf_elf64Phdr){1U, 7U, 0U, elf_addressOffset, elf_addressOffset, (uint64_t)main_getProgramSize(), (uint64_t)main_getProgramSize(), 0x1000U};
  elf_elf64Ehdr header = (elf_elf64Ehdr){{0x7fU, 0x45U, 0x4cU, 0x46U, 2U, 1U, 1U, 0U}, 2U, 243U, 1U, (uint64_t)(int64_t)((int64_t)((64 + elf_addressOffset) + (nelua_sequence_elf64Shdr____len((&elf_shdrs)) * 64)) + start), (uint64_t)((64 + main_getProgramSize()) + (nelua_sequence_elf64Shdr____len((&elf_shdrs)) * 64)), 64U, 4U, 64U, 56U, 1U, 64U, (uint16_t)nelua_sequence_elf64Shdr____len((&elf_shdrs)), 0U};
  (*(elf_elf64Shdr*)nelua_assert_deref(nelua_sequence_elf64Shdr____atindex((&elf_shdrs), 2U))).sh_size = nelua_assert_narrow_nlint64_nluint64(elf_nameLen);
  ...
  for(intptr_t i = 1, _end = nelua_sequence_elf64Shdr____len((&elf_shdrs)); i < _end; i += 1) {
    fwrite((void*)(&(*(elf_elf64Shdr*)nelua_assert_deref(nelua_sequence_elf64Shdr____atindex((&elf_shdrs), 1U)))), 64U, 1U, (void*)file);
  }
  fwrite((void*)(&(*(uint32_t*)nelua_assert_deref(nelua_sequence_uint32____atindex((&program_1), 1U)))), 4U, nelua_assert_narrow_nlisize_nlcsize(nelua_sequence_uint32____len((&program_1))), (void*)file);
  fwrite((void*)(&ph), 56U, 1U, (void*)file);
  if((!strip)) {
    {
      nlmulret_function_2XS1go9rn2UatzpfF_nelua_hashmap_iteratorT_6_nlstring _asgnret_1 = nelua_pairs_2((&elf_names));
      function_2XS1go9rn2UatzpfF __fornext = _asgnret_1.r1;
...
nlstring main_parseString(nlstring str) {
  bool escape = false;
  nlstring retStr = ((nlstring){(uint8_t*)"", 0});
  str = nelua_nlstring_sub_1(str, 2, nelua_nlstring___len(str));
  {
    nlmulret_function_2vLzwm7GgVbixrMzR_nlstring_ptr_nlint64 _asgnret_1 = nelua_ipairs_2((&str));
    function_2vLzwm7GgVbixrMzR __fornext = _asgnret_1.r1;
      ...
      __fornextit = _;
      {
        if(escape) {
          switch(char_) {
            ...
            case 101: {
              retStr = nelua_nlstring___concat_3(retStr, 0x1b);
              break;
            }
            case 110: {
            ...
            default: {
              nelua_print_1(((nlstring){(uint8_t*)"Error: Invaild escape sequence", 30}));
              nelua_os_exit_1(1);
              break;
            }
          }
          ...
          switch(char_) {
            ...
            default: {
              retStr = nelua_nlstring___concat_1(retStr, nelua_nlstring_char_1(char_));
              break;
            }
          }
        }
...
uint32_t nelua_shl_nluint32(uint32_t a, int32_t b) {
  if(NELUA_LIKELY(b >= 0 && b < 32)) {
    return ((uint32_t)a) << b;
  } else if(NELUA_UNLIKELY(b < 0 && b > -32)) {
    return (uint32_t)a >> -b;
  } else {
    return 0;
  }
...
int nelua_main(int argc, char** argv) {
  ...
  main_file = nelua_io_open_1(argHandling_filein, NELUA_NIL).r1;
  if((!true)) {
  ...
  {
    nlmulret_function_DoRkucoJPU9mcyeq_nelua_LinesState_nlstring _asgnret_1 = nelua_filestream_lines_1((&main_file), NELUA_NIL);
    function_DoRkucoJPU9mcyeq __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = line;
      {
        if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"^%s*#", 5}), NELUA_NIL).r1) {
          continue;
        }
        if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%s*%S*:%s*$", 11}), NELUA_NIL).r1) {
          nlstring label = (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex(NELUA_LITERAL_REF(nelua_sequence_string_, (({
            nlmulret_nlboolean_nelua_sequence_string_ _tmp1 = nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%s*(%S*):", 9}), NELUA_NIL);
            nelua_select_1(NELUA_NIL, _tmp1.r1, _tmp1.r2);
          }))), 1U)));
          if((!nelua_nlstring___eq(main_curLabel, ((nlstring){(uint8_t*)"", 0})))) {
            (*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), main_curLabel))) = (nelua_V_3){(uint64_t)main_preAddressLabel, (main_addressLabel - main_preAddressLabel)};
          }
          main_preAddressLabel = main_addressLabel;
          main_curLabel = label;
        } else if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%S+%s*=%s*%S+", 13}), NELUA_NIL).r1) {
          nelua_sequence_string_ args = ({
            nlmulret_nlboolean_nelua_sequence_string_ _tmp1 = nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"(%S+)%s*=%s*(%S+)", 17}), NELUA_NIL);
            nelua_select_1(NELUA_NIL, _tmp1.r1, _tmp1.r2);
          });
          if(nelua_nlstring_match_1((*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&args), 2U))), ((nlstring){(uint8_t*)"[\"']", 4}), NELUA_NIL).r1) {
            nlstring str = main_parseString((*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&args), 2U))));
            intptr_t len = ((nelua_nlstring___len(str) + 3) & -4);
            intptr_t pi = 0;
            for(intptr_t i = 0, _end = nelua_nlstring___len(str); i < _end; i += 1) {
              if((nelua_assert_imod_nlisize(i, 4) == 0)) {
                pi = (nelua_sequence_uint32____len((&main_program)) + 1);
              }
              (*(uint32_t*)nelua_assert_deref(nelua_sequence_uint32____atindex((&main_program), nelua_assert_narrow_nlisize_nlusize(pi)))) = ((*(uint32_t*)nelua_assert_deref(nelua_sequence_uint32____atindex((&main_program), nelua_assert_narrow_nlisize_nlusize(pi)))) | nelua_shl_nluint32((uint32_t)(*(uint8_t*)nelua_assert_deref(nelua_nlstring___atindex(str, nelua_assert_narrow_nlisize_nlusize((i + 1))))), (nelua_assert_imod_nlisize(i, 4) * 8)));
            }
            main_stringLen = nelua_assert_narrow_nlint64_nluint64((int64_t)(main_stringLen + len));
            (*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&args), 1U)))))) = (nelua_V_3){(uint64_t)main_addressLabel, (int64_t)len};
            main_addressLabel = (int64_t)(main_addressLabel + len);
          } else {
            (*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&args), 1U)))))) = (nelua_V_3){(uint64_t)nelua_tointeger_1((*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&args), 2U))), NELUA_NIL), -1};
          }
        } else if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%S", 2}), NELUA_NIL).r1) {
          nlmulret_nlboolean_nelua_sequence_string_ _asgnret_3 = nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%s*([^%s]*)%s*(.*)", 18}), NELUA_NIL);
          nelua_sequence_string_ b = _asgnret_3.r2;
          nlstring mnemonic = nelua_nlstring_lower((*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 1U))));
          intptr_t length = 0;
          if(nelua_hashmap_string__V__1_has((&instr_instruction), mnemonic)) {
            length = 4;
          } else {
            nlmulret_nlisize_nluint32_arr3 _asgnret_4 = instr_getArgs(mnemonic, (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 2U))));
            nluint32_arr3 args = _asgnret_4.r2;
            length = (nelua_sequence_uint32____len(NELUA_LITERAL_REF(nelua_sequence_uint32_, ((*(nelua_V_5*)nelua_assert_deref(nelua_hashmap_string__V__2___atindex((&pseudo_pseudoInstr), mnemonic))).assemble(args)))) * 4);
          }
          main_addressLabel = (int64_t)(main_addressLabel + length);
        }
      }
    }
  }
  ...
  if((!nelua_hashmap_string__V__has((&label_labels), ((nlstring){(uint8_t*)"_start", 6})))) {
    nelua_print_1(((nlstring){(uint8_t*)"Error: failed to find '_start' label", 36}));
    nelua_os_exit_1(1);
  }
  nelua_filestream_seek_1((&main_file), ((nlstring){(uint8_t*)"set", 3}), NELUA_NIL);
  {
    nlmulret_function_DoRkucoJPU9mcyeq_nelua_LinesState_nlstring _asgnret_5 = nelua_filestream_lines_1((&main_file), NELUA_NIL);
    function_DoRkucoJPU9mcyeq __fornext = _asgnret_5.r1;
    nelua_LinesState __forstate = _asgnret_5.r2;
    nlstring __fornextit = _asgnret_5.r3;
    while(true) {
      nlmulret_nlboolean_nlstring _asgnret_6 = __fornext(__forstate, __fornextit);
      bool __forcont = _asgnret_6.r1;
      nlstring line = _asgnret_6.r2;
      if((!__forcont)) {
        break;
      }
      __fornextit = line;
      {
        ...
        if(nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%S", 2}), NELUA_NIL).r1) {
          nlmulret_nlboolean_nelua_sequence_string_ _asgnret_7 = nelua_nlstring_match_1(line, ((nlstring){(uint8_t*)"%s*([^%s]*)%s*(.*)", 18}), NELUA_NIL);
          nelua_sequence_string_ b = _asgnret_7.r2;
          nlstring mnemonic = nelua_nlstring_lower((*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 1U))));
          nlmulret_nlisize_nluint32_arr3 _asgnret_8 = instr_getArgs(mnemonic, (*(nlstring*)nelua_assert_deref(nelua_sequence_string____atindex((&b), 2U))));
          nluint32_arr3 args = _asgnret_8.r2;
          if(nelua_hashmap_string__V__1_has((&instr_instruction), mnemonic)) {
            (*(uint32_t*)nelua_assert_deref(nelua_sequence_uint32____atindex((&main_program), nelua_assert_narrow_nlisize_nlusize((nelua_sequence_uint32____len((&main_program)) + 1))))) = instr_getInstr(mnemonic, args);
          } else if(nelua_hashmap_string__V__2_has((&pseudo_pseudoInstr), mnemonic)) {
            nelua_sequence_uint32_ instres = (*(nelua_V_5*)nelua_assert_deref(nelua_hashmap_string__V__2___atindex((&pseudo_pseudoInstr), mnemonic))).assemble(args);
            for(intptr_t i = 1, _end = nelua_sequence_uint32____len((&instres)); i <= _end; i += 1) {
              (*(uint32_t*)nelua_assert_deref(nelua_sequence_uint32____atindex((&main_program), nelua_assert_narrow_nlisize_nlusize((nelua_sequence_uint32____len((&main_program)) + 1))))) = (*(uint32_t*)nelua_assert_deref(nelua_sequence_uint32____atindex((&instres), nelua_assert_narrow_nlisize_nlusize(i))));
            }
          }
        }
        main_curLine = (main_curLine + 1);
      }
    }
  }
  ...
  if(argHandling_execArgs.dump) {
    {
      nlmulret_function_2xeznntUSZa5dDBQC_nelua_sequence_uint32__nlint64 _asgnret_9 = nelua_ipairs_3(main_program);
      function_2xeznntUSZa5dDBQC __fornext = _asgnret_9.r1;
      nelua_sequence_uint32_ __forstate = _asgnret_9.r2;
      int64_t __fornextit = _asgnret_9.r3;
      while(true) {
        nlmulret_nlboolean_nlint64_nluint32 _asgnret_10 = __fornext(__forstate, __fornextit);
        bool __forcont = _asgnret_10.r1;
        int64_t _ = _asgnret_10.r2;
        uint32_t v = _asgnret_10.r3;
        if((!__forcont)) {
          break;
        }
        __fornextit = _;
        {
          fwrite((void*)(&v), 4U, 1U, (void*)main_cfile);
        }
      }
    }
    fclose(main_cfile);
  }
  elf_writeToFile(argHandling_fileout, main_program, (*(nelua_V_3*)nelua_assert_deref(nelua_hashmap_string__V____atindex((&label_labels), ((nlstring){(uint8_t*)"_start", 6})))).value, true);
  nelua_io_popen_1(nelua_nlstring___concat_1(((nlstring){(uint8_t*)"chmod +x ", 9}), argHandling_fileout), NELUA_NIL);
  return 0;
}
